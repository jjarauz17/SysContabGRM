...
Public Class Firma
    ...
    Public Sub FirmaXML_Xades(pathXML As String,
                              Certificado As String,
                              esThumbprint As Boolean,
                              Clave As String,
                              FirmaUrl As String)
        Try
            ...
            Dim Cert As X509Certificate2 = New X509Certificate2(Certificado, Clave)
            ...
            Dim objReader As StreamReader = File.OpenText(pathXML & "_XML_SinFirma.xml")
            ...
            ms.Flush()
            ms.Position = 0
            Dim DocFirmado As Object = XadesService.Sign(ms, parametros)
            DocFirmado.Save(pathXML & "_XML_Firmado.xml")

            'Dim fs As FileStream = New FileStream(pathXML & "_XML_SinFirma.xml", FileMode.Open)
        ...
        Catch ex As Exception
            XtraMsg("Error en Firma: " & vbCrLf & ex.Message,
