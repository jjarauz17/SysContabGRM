...
Public Class frmPresupuestoGastosConsolidado
    ...
    Sub LlenarGrid()
        ...
        Dim DT As DataTable = db_Presupuesto.ReporteDinamicoGastosConsolidado(cbPeriodo.EditValue)
        '
        ...
        Else
            ...
            iPivotGrid.Fields("CentroCosto").Width = 200
        End If
    ...
    Private Sub iPivotGrid_CustomAppearance(sender As Object, e As PivotCustomAppearanceEventArgs) Handles iPivotGrid.CustomAppearance
        If e.DataField.ToString() = "Variación" Then
            ...
            If (e.GetFieldValue(e.DataField) < 0.00) Then
                ...
                'ElseIf ((e.GetFieldValue(e.DataField) > 0.00) And e.GetFieldValue(iPivotGrid.Fields.Item("Estimado"))) > 0 Then
