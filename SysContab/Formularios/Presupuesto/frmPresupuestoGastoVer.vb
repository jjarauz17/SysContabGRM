...
Public Class frmPresupuestoGastoVer
    ...
    Sub Mostrar(ID As Integer, Sucursal As String, CentroCosto As String, Periodo As String)
    ...
    Sub LlenarGrid()
        Dim DT As DataTable = db_Presupuesto.ReporteDinamicoGastos(IdPresupuesto)
        '
        ...
        Next
        '
        iPivotGrid.Fields("Cuenta").Width = 200
        iPivotGrid.Fields("Grupo").Width = 200

        iPivotGrid.Fields("Grupo").Area = DevExpress.XtraPivotGrid.PivotArea.RowArea
        ...
        iPivotGrid.Fields("Estimado").Area = DevExpress.XtraPivotGrid.PivotArea.DataArea
    ...
    Private Sub iPivotGrid_CustomAppearance(sender As Object, e As PivotCustomAppearanceEventArgs) Handles iPivotGrid.CustomAppearance
        If e.DataField.ToString() = "Variación" Then
            ...
            ElseIf ((e.GetFieldValue(e.DataField) > 0.00) And e.GetFieldValue(iPivotGrid.Fields.Item("Variación"))) > 0 Then
