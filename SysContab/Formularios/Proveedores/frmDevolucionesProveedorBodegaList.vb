...
Public Class frmDevolucionesProveedorBodegaList
    Inherits DevExpress.XtraEditors.XtraForm

    Private Shared ChildInstance As frmDevolucionesProveedorBodegaList = Nothing

    Public Shared Function Instance() As frmDevolucionesProveedorBodegaList
        If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
            ChildInstance = New frmDevolucionesProveedorBodegaList()
        End If
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GroupBox1.Location = New System.Drawing.Point(8, 446)
        ...
        Me.cmdDevoluciones.Text = "&Ver Salida"
        '
        'Label1
        '
        ...
        Me.dgFacturasClientes.Size = New System.Drawing.Size(1000, 354)
        ...
        '
        'frmDevolucionesProveedorBodegaList
        '
        ...
        Me.Name = "frmDevolucionesProveedorBodegaList"
...
#End Region
    ...
    Private Sub frmListaFacturaClientes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dgFacturasClientes.CaptionText = "          Salidas de Bodega por Devoluciones"

        r.ComboAutoComplete(Me.cbProveedores)

        Me.Text = "Salidas de Bodega por Devoluciones"
        Me.Refresh()
    ...
    Private Sub checkBoxFecha_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles checkBoxFecha.CheckedChanged
        ...
        Try
            ...
            End If
            ds = Devoluciones.GetListDevolucionesBodega(Me.txtFactura.Text, Me.cbProveedores.SelectedValue, Fecha1, Fecha2)
            dgFacturasClientes.DataSource = ds.Tables("DevolucionesCliente").DefaultView
    ...
    Private Sub cbClientes_SelectedValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbProveedores.SelectedValueChanged
        If etInicio.Text = "1" Then
            Exit Sub
        End If
    ...
    Private Sub cmdDevoluciones_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDevoluciones.Click
        ...
        Dim f As DataGridTextBoxCombo.frmDevolucionProveedorBodegaVer = f.Instance
    ...
    Private Sub cmdEntradaBodega_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEntradaBodega.Click
        If DevolucionBodega.DevolucionDetalleNew(dgFacturasClientes.Item(dgFacturasClientes.CurrentRowIndex, 0), dgFacturasClientes.Item(dgFacturasClientes.CurrentRowIndex, 1), dgFacturasClientes.Item(dgFacturasClientes.CurrentRowIndex, 7)).Tables("Facturas_Compras").Rows.Count = 0 Then
            MsgBox("La devolucion ya fue procesada...", MsgBoxStyle.Information)
            Exit Sub
        End If

        Dim f As DataGridTextBoxCombo.frmDevolucionProveedorBodega = f.Instance
        f.txtDevolucion.Text = Me.dgFacturasClientes.Item(Me.dgFacturasClientes.CurrentRowIndex, 0)
        f.txtFactura.Text = Me.dgFacturasClientes.Item(Me.dgFacturasClientes.CurrentRowIndex, 1)
        f.txtCodigoProveedor.Text = Me.dgFacturasClientes.Item(Me.dgFacturasClientes.CurrentRowIndex, 7)
