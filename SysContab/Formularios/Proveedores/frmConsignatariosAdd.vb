Public Class frmConsignatariosAdd
    ...
    Private Sub bGuardar_Click(sender As Object, e As EventArgs) Handles bGuardar.Click
        ...
        If IdDetalle = 0 Then   'Editar
            GuardaDatos("INSERT INTO Consignatarios (Nombre,	Descripcion, Empresa) " & _
                        "VALUES ('" & txtNombre.Text & "','" & txtDescripcion.Text & "'," & EmpresaActual & ")")
            Ok = "SI"
            Close()
        Else                    'Actualizar
            GuardaDatos("UPDATE Consignatarios SET Nombre = '" & txtNombre.Text & "'," & _
