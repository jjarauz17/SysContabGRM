Public Class frmMetodosEnvio
    ...
    Public Sub Cargar()
        Me.dgDatos.DataSource = ObtieneDatos("JAR_GetMetodosEnvio " & EmpresaActual)
    ...
    Private Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        frmMetodoEnvioAdd.Text = "Nuevo..."
        frmMetodoEnvioAdd.ShowDialog()
        If frmMetodoEnvioAdd.Ok = "SI" Then Cargar()
        frmMetodoEnvioAdd.Dispose()
    End Sub
    ...
    Private Sub btnBorrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBorrar.Click
        ...
        End If
        '
        If XtraMsg2("Esta Seguro de Borrar el Metodos_Envio: " + Me.vDatos.GetFocusedRowCellValue("Nombre") + "?") Then
            If GuardaDatos("DELETE FROM Metodos_Envio WHERE IdDetalle =  " & Me.vDatos.GetFocusedRowCellValue("IdDetalle")) Then
                Cargar()
            End If
        End If
    End Sub
