...
Namespace DataGridTextBoxCombo
    Public Class frmFacturaProveedorEditarFP
        Inherits DevExpress.XtraEditors.XtraForm

        Private Shared ChildInstance As frmFacturaProveedorEditarFP = Nothing

        Public Shared Function Instance() As frmFacturaProveedorEditarFP
            If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
                ChildInstance = New frmFacturaProveedorEditarFP()
            End If
...
#Region " Código generado por el Diseñador de Windows Forms "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.Label7.Location = New System.Drawing.Point(368, 534)
            ...
            Me.txtDocumento.Location = New System.Drawing.Point(504, 534)
            ...
            Me.cmdAceptar.Location = New System.Drawing.Point(16, 534)
            ...
            Me.cmdSalir.Location = New System.Drawing.Point(288, 534)
            ...
            Me.dgCatalogo.Location = New System.Drawing.Point(8, 207)
            ...
            Me.dgCatalogo.Size = New System.Drawing.Size(1000, 319)
            ...
            Me.cmdRecalcular.Location = New System.Drawing.Point(104, 534)
            ...
            Me.cmdBorrar.Location = New System.Drawing.Point(200, 534)
            Me.cmdBorrar.Name = "cmdBorrar"
            Me.cmdBorrar.Size = New System.Drawing.Size(72, 26)
            Me.cmdBorrar.TabIndex = 155
            Me.cmdBorrar.Text = "&Borrar"
            '
            'frmFacturaProveedorEditarFP
            '
            ...
            Me.Name = "frmFacturaProveedorEditarFP"
...
#End Region
        ...
        Private Sub frmFacturaProveedorEditarFP_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Private Sub frmFacturaProveedorEditar_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
            ...
            Dim f1 As frmListaFacturaProveedores = f1.Instance
            ''f1.Buscar()
            f1.ds = FacturasDB.FacturasComprasPendientes
            f1.dgFacturasP.DataSource = f1.ds.Tables("Tablas").DefaultView
