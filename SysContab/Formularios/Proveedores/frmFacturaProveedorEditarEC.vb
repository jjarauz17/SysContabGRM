...
Namespace DataGridTextBoxCombo
    Public Class frmFacturaProveedorEditarEC
        Inherits DevExpress.XtraEditors.XtraForm

        Private Shared ChildInstance As frmFacturaProveedorEditarEC = Nothing

        Public Shared Function Instance() As frmFacturaProveedorEditarEC
            If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
                ChildInstance = New frmFacturaProveedorEditarEC()
            End If
...
#Region " Código generado por el Diseñador de Windows Forms "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.Label7.Location = New System.Drawing.Point(360, 359)
            ...
            Me.txtDocumento.Location = New System.Drawing.Point(496, 359)
            ...
            Me.cmdAceptar.Location = New System.Drawing.Point(8, 359)
            ...
            Me.cmdSalir.Location = New System.Drawing.Point(280, 359)
            ...
            Me.dgCatalogo.Location = New System.Drawing.Point(8, 189)
            ...
            Me.dgCatalogo.Size = New System.Drawing.Size(1000, 164)
            ...
            Me.cmdRecalcular.Location = New System.Drawing.Point(96, 359)
            ...
            Me.cmdBorrar.Location = New System.Drawing.Point(192, 359)
            Me.cmdBorrar.Name = "cmdBorrar"
            Me.cmdBorrar.Size = New System.Drawing.Size(72, 26)
            Me.cmdBorrar.TabIndex = 155
            Me.cmdBorrar.Text = "&Borrar"
            '
            'frmFacturaProveedorEditarEC
            '
            Me.AutoScaleBaseSize = New System.Drawing.Size(5, 14)
            Me.ClientSize = New System.Drawing.Size(1016, 391)
            ...
            Me.Name = "frmFacturaProveedorEditarEC"
...
#End Region
        ...
        Private _Modifica As Boolean = True
        Private _TipoC As Integer = 2
...
Ciclo:
                ...
                With tCust.Rows(i)
                    ...
                    If CTemp <> Nothing Then
                        ...
                        Else
                            ...
                            Valor = .Item("Monto")
                        End If
                        DT.DefaultView.RowFilter = "Cuenta = '" & .Item("Codigo1") & "' AND NoComp = " & Comp & _
        ...
        Private Sub frmFacturaProveedorEditarEC_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            'Me.dtpFecha.MinDate = VB.SysContab.PeriodosDB.GetDetails(VB.SysContab.PeriodosDB.Activo).Inicio
            'Me.dtpFecha.MaxDate = VB.SysContab.PeriodosDB.GetDetails(VB.SysContab.PeriodosDB.Activo).Final
            ...
            Me.cbFormaPago.SelectedValue = IIf(compDet.FormaPago.ToString.Length = 0, 0, compDet.FormaPago)
            Me.txtConcepto.Text = compDet.Concepto
            Me.cbProveedor.SelectedValue = IIf(compDet.Proveedor.ToString.Length = 0, 0, compDet.Proveedor)
            Me.txtFactura.Text = compDet.Factura1
            Me.dtpFecha.Value = IIf(compDet.Fecha.ToString.Length = 0, Now.Date, compDet.Fecha)
            Me.dtpFechaPago.Value = IIf(compDet.FechaPago.ToString.Length = 0, Now.Date, compDet.FechaPago)
            ...
            v.AddParameter("Comprobante", SqlDbType.Int, 5, ParameterDirection.Input, Me.Comp)
            v.AddParameter("Periodo", SqlDbType.Int, 5, ParameterDirection.Input, Me.Per)
            v.AddParameter("Mes", SqlDbType.Int, 5, ParameterDirection.Input, CDate(Me.Fecha).Month)
            v.AddParameter("Pagos", SqlDbType.Int, 5, ParameterDirection.Output, 0)

            v.EjecutarComando("_Buscar_PagosFacturas")
            If v.GetParameter("Pagos").Valor = 0 Then
        ...
        Private Sub cmdAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAceptar.Click
            If VerificaDistribucion() = False And ObligarDistribucion = True Then Exit Sub
        ...
        Private Function Guardar() As Boolean
            ...
            Try
                ...
                For i = 0 To tCust.Rows.Count - 1
                    ...
                    'DC = "D"
                    'Opera = 1
                    'en lugar de las dos primeras secciones del if

                    If CDbl(tCust.Rows(i)("Monto")) >= 0 Then ' VB.SysContab.CatalogoDB.CatalogoXCuenta(tCust.Rows(i)("Codigo1")).Tables("Catalogo").Rows(0).Item("Clase") = 1 And 
                        DC = "D" '"C"
                        Opera = 1 '2
                    ElseIf CDbl(tCust.Rows(i)("Monto")) < 0 Then 'VB.SysContab.CatalogoDB.CatalogoXCuenta(tCust.Rows(i)("Codigo1")).Tables("Catalogo").Rows(0).Item("Clase") = 1 And 
                        DC = "C" '"D"'
                        Opera = 2 '1
                    End If
                    'ElseIf CDbl(tCust.Rows(i)("Monto")) >= 0 Then  'VB.SysContab.CatalogoDB.CatalogoXCuenta(tCust.Rows(i)("Codigo1")).Tables("Catalogo").Rows(0).Item("Clase") = 2 And
                    'DC = "D"
                    'Opera = 1
                    'ElseIf CDbl(tCust.Rows(i)("Monto")) < 0 Then  'VB.SysContab.CatalogoDB.CatalogoXCuenta(tCust.Rows(i)("Codigo1")).Tables("Catalogo").Rows(0).Item("Clase") = 2 And
                    'DC = "C"
