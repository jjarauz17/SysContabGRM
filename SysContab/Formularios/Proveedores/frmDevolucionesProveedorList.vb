...
Public Class frmDevolucionesProveedorList
    Inherits DevExpress.XtraEditors.XtraForm

    Private Shared ChildInstance As frmDevolucionesProveedorList = Nothing

    Public Shared Function Instance() As frmDevolucionesProveedorList
        If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
            ChildInstance = New frmDevolucionesProveedorList()
        End If
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'GroupBox1
        '
        Me.GroupBox1.Controls.Add(Me.cmdEntradaBodegaList)
        Me.GroupBox1.Controls.Add(Me.cmdEntradaBodega)
        Me.GroupBox1.Controls.Add(Me.cmdSalir)
        Me.GroupBox1.Controls.Add(Me.cmdDevoluciones)
        Me.GroupBox1.Location = New System.Drawing.Point(11, 413)
        ...
        Me.cmdEntradaBodegaList.Location = New System.Drawing.Point(224, 17)
        Me.cmdEntradaBodegaList.Name = "cmdEntradaBodegaList"
        Me.cmdEntradaBodegaList.Size = New System.Drawing.Size(80, 35)
        Me.cmdEntradaBodegaList.TabIndex = 162
        Me.cmdEntradaBodegaList.Text = "Ver Salidas de &Bodegas"
        '
        'cmdEntradaBodega
        '
        ...
        Me.cmdEntradaBodega.Location = New System.Drawing.Point(120, 17)
        ...
        Me.cmdEntradaBodega.Text = "&Salida de Bodega"
        '
        'cmdSalir
        '
        Me.cmdSalir.Location = New System.Drawing.Point(328, 17)
        ...
        Me.cmdDevoluciones.Text = "&Ver Devolución"
        '
        'Label1
        '
        ...
        Me.dgFacturasClientes.Location = New System.Drawing.Point(11, 81)
        ...
        Me.dgFacturasClientes.Size = New System.Drawing.Size(1000, 326)
        ...
        Me.cbProveedores.Location = New System.Drawing.Point(120, 52)
        Me.cbProveedores.Name = "cbProveedores"
        Me.cbProveedores.Size = New System.Drawing.Size(480, 23)
        Me.cbProveedores.TabIndex = 157
        '
        'etInicio
        '
        ...
        Me.Name = "frmDevolucionesProveedorList"
...
#End Region
    ...
    Dim Devoluciones As New VB.SysContab.DevolucionesProveedor()
    ...
    Private Sub frmListaFacturaClientes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ds = Devoluciones.GetList("", Proveedor, "", "")
        ...
        dgFacturasClientes.CaptionText = "          Devoluciones a Proveedores"

        r.ComboAutoComplete(Me.cbProveedores)

        Me.Text = "D e v o l u c i o n e s  a  P r o v e e d o r e s"
        Me.Refresh()
    ...
    '            dgFacturasClientes.DataSource = Clientes.FacturasXTipo(txtBuscar.Text, cbTipoFactura.SelectedValue.ToString, cbMeses.SelectedIndex).Tables("Facturas_Compras").DefaultView
    '        End If
    ...
    '        dgFacturasClientes.DataSource = Clientes.ListFacturas("").Tables("Facturas_Compras").DefaultView
    '    End If
    'End Sub
    ...
    Private Sub checkBoxFecha_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles checkBoxFecha.CheckedChanged
        ...
        Try
            ...
            End If
            ds = Devoluciones.GetList(Me.txtFactura.Text, Me.cbProveedores.SelectedValue, Fecha1, Fecha2)
            dgFacturasClientes.DataSource = ds.Tables("DevolucionesCliente").DefaultView
    ...
    Private Sub cbProveedores_SelectedValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbProveedores.SelectedValueChanged
        If etInicio.Text = "1" Then
            Exit Sub
        End If
        ...
        Try
            ...
            dgFacturasClientes.DataSource = ds.Tables("DevolucionesCliente").DefaultView
        Catch ex As Exception
            MsgBox(ex.Message & " cbProveedores_SelectedValueChanged")
    ...
    Private Sub cmdDevoluciones_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDevoluciones.Click
        'If Clientes.FacturaDetalleDevolucion(dgFacturasClientes.Item(dgFacturasClientes.CurrentRowIndex, 0)).Tables("Facturas_Compras").Rows.Count = 0 Then
        '    MsgBox("La Factura no tiene productos para devolución", MsgBoxStyle.Information)
        '    Exit Sub
        'End If

        'Mostrar la Lista de Facturas
        If Me.dgFacturasClientes.Item(Me.dgFacturasClientes.CurrentRowIndex, 0).ToString = "" Then
            MsgBox("Seleccione un Registro", MsgBoxStyle.Information)
            Exit Sub
        End If

        Dim f As DataGridTextBoxCombo.frmDevolucionProveedorVer = f.Instance
    ...
    Private Sub cmdEntradaBodega_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEntradaBodega.Click
        ...
        If DevolucionBodega.DevolucionDetalleNew(dgFacturasClientes.Item(dgFacturasClientes.CurrentRowIndex, 0), dgFacturasClientes.Item(dgFacturasClientes.CurrentRowIndex, 1), dgFacturasClientes.Item(dgFacturasClientes.CurrentRowIndex, 6)).Tables("Facturas_Compras").Rows.Count = 0 Then
            MsgBox("La devolucion ya fue procesada...", MsgBoxStyle.Information)
            Exit Sub
        End If

        Dim f As DataGridTextBoxCombo.frmDevolucionProveedorBodega = DataGridTextBoxCombo.frmDevolucionProveedorBodega.Instance
        f.txtDevolucion.Text = Me.dgFacturasClientes.Item(Me.dgFacturasClientes.CurrentRowIndex, 0)
        f.txtFactura.Text = Me.dgFacturasClientes.Item(Me.dgFacturasClientes.CurrentRowIndex, 1)
        f.txtCodigoProveedor.Text = Me.dgFacturasClientes.Item(Me.dgFacturasClientes.CurrentRowIndex, 6)
    ...
    Private Sub frmDevolucionesClienteList_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        ...
        Dim f1 As frmAgregarProveedor = frmAgregarProveedor.Instance
        f1.etInicio.Text = "0"
    End Sub
    ...
    Private Sub cmdEntradaBodegaList_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEntradaBodegaList.Click
        Me.etInicio.Text = "1"
        Dim f As frmDevolucionesProveedorBodegaList = frmDevolucionesProveedorBodegaList.Instance
        f.etInicio.Text = "1"
        f.MdiParent = Me.MdiParent
        f.Show()
        f.WindowState = FormWindowState.Maximized
