...
Namespace DataGridTextBoxCombo
    Public Class frmDevolucionProveedorBodega
        Inherits DevExpress.XtraEditors.XtraForm

        Private Shared ChildInstance As frmDevolucionProveedorBodega = Nothing

        Public Shared Function Instance() As frmDevolucionProveedorBodega
            If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
                ChildInstance = New frmDevolucionProveedorBodega()
            End If
...
#Region " Código generado por el Diseñador de Windows Forms "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.txtCliente.Location = New System.Drawing.Point(88, 8)
            ...
            Me.cbCliente.Location = New System.Drawing.Point(88, 8)
            Me.cbCliente.Name = "cbCliente"
            Me.cbCliente.Size = New System.Drawing.Size(304, 21)
            ...
            Me.GroupBox3.Controls.Add(Me.txtCodigoProveedor)
            ...
            Me.txtCodigoProveedor.Location = New System.Drawing.Point(344, 252)
            Me.txtCodigoProveedor.MaxLength = 50
            Me.txtCodigoProveedor.Name = "txtCodigoProveedor"
            Me.txtCodigoProveedor.ReadOnly = True
            Me.txtCodigoProveedor.Size = New System.Drawing.Size(184, 20)
            Me.txtCodigoProveedor.TabIndex = 158
            ...
            Me.cbTodos.Location = New System.Drawing.Point(768, 17)
            ...
            Me.etSaldoT.Location = New System.Drawing.Point(16, 441)
            ...
            Me.etSaldo.Location = New System.Drawing.Point(80, 441)
            ...
            Me.etSubTotal.Location = New System.Drawing.Point(280, 441)
            ...
            Me.etSubTotalT.Location = New System.Drawing.Point(192, 441)
            ...
            Me.etIva.Location = New System.Drawing.Point(504, 441)
            Me.etIva.Name = "etIva"
            ...
            Me.etIvaT.Location = New System.Drawing.Point(400, 441)
            ...
            Me.gbBotones.Location = New System.Drawing.Point(912, 43)
            Me.gbBotones.Name = "gbBotones"
            Me.gbBotones.Size = New System.Drawing.Size(88, 384)
            ...
            Me.cmdConsultaClientes.Location = New System.Drawing.Point(8, 233)
            ...
            Me.cmdVerPagos.Location = New System.Drawing.Point(8, 276)
            ...
            Me.etTotal.Location = New System.Drawing.Point(688, 432)
            ...
            Me.etTotalT.Location = New System.Drawing.Point(624, 441)
            ...
            Me.dgFacturacionCliente.Size = New System.Drawing.Size(896, 384)
            ...
            Me.txtDevolucion.Location = New System.Drawing.Point(512, 9)
            Me.txtDevolucion.MaxLength = 50
            Me.txtDevolucion.Name = "txtDevolucion"
            Me.txtDevolucion.ReadOnly = True
            Me.txtDevolucion.Size = New System.Drawing.Size(120, 20)
            ...
            Me.Name = "frmDevolucionProveedorBodega"
...
#End Region
        ...
        Dim DevolucionBodega As New VB.SysContab.DevolucionesProveedorBodegaDB()
        ...
        Dim EncabezadoComprobante As DataSet
        Dim DetalleComprobante As DataSet

        Dim Plantilla As VB.SysContab.PlantillaDetails
        ...
        Private Sub frmDevolucionClienteBodega_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ''r.CambiarEstilo(Me)
            r.FormularioColor(Me)

            cbCliente.DataSource = Proveedores.ProveedoresList(3).Tables("Proveedores")
            cbCliente.ValueMember = "Codigo"
            cbCliente.DisplayMember = "Nombre"

            ConfigDetalles = Config.GetConfigDetails

            'txtFactura.Text = Devolucion.DevolucionDetalle(Me.txtDevolucion.Text).Tables("Facturas_Compras").Rows(0).Item("Factura")
            'txtFactura.ReadOnly = True

            ds = DevolucionBodega.DevolucionDetalleNew(Me.txtDevolucion.Text, Me.txtFactura.Text, Me.txtCodigoProveedor.Text) 'Clientes.FacturaDetalleDevolucion(txtFactura.Text)

            dgFacturacionCliente.ReadOnly = False

            cbCliente.Enabled = False

            'If ds.Tables("Facturas_Compras").Rows(0).Item("Cliente") = "9999" Then
            '    txtCliente.Text = ds.Tables("Facturas_Compras").Rows(0).Item("Nombre_Cliente").ToString
            '    txtCliente.Visible = True
            'Else
            txtCliente.Visible = False
            cbCliente.SelectedValue = ds.Tables("Facturas_Compras").Rows(0).Item("Proveedor_ID")
            Me.Bodega = ds.Tables("Facturas_Compras").Rows(0).Item("codigo_bodega")
            Me.Proveedor = ds.Tables("Facturas_Compras").Rows(0).Item("Proveedor_ID")
            Me.TipoFactura = ds.Tables("Facturas_Compras").Rows(0).Item("Tipo_ITEM")
            Me.cFormapago = ds.Tables("Facturas_Compras").Rows(0).Item("Forma_pago")
            'End If

            dtpFecha.Value = ds.Tables("Facturas_Compras").Rows(0).Item("Factura_Fecha")
            'Se deja editable la fecha, para que seleccionen el periodo en que se efectuo la transaccion.
            'dtpFecha.Enabled = False

            'txtFactura.Text = ds.Tables("Facturas_Compras").Rows(0).Item("Factura")
            'txtFactura.ReadOnly = True
            ...
            Me.Text = "Salida de Bodega por Devolución"
        ...
        Private Sub TextBoxCantidadLeaveHandler(ByVal sender As Object, ByVal e As EventArgs)
            ...
            Else
                If CDbl(Cantidad.TextBox.Text) <= 0 Then
                    ...
                    Exit Sub
                Else
                    If CDbl(Cantidad.TextBox.Text) > ds.Tables("Facturas_Compras").Rows(Me.dgFacturacionCliente.CurrentRowIndex).Item("Cantidad") Then
                        MsgBox("La cantidad debe ser menor o igual a la cantidad Devuelta", MsgBoxStyle.Information)
                        Cantidad.TextBox.Text = ValorActualCantidad
                        Exit Sub
                    End If
                End If
        ...
        Private Sub cmdAceptar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdAceptar.Click
            ...
            Dim j As Integer
            Dim x As Integer
            Numero = DevolucionBodega.Numero
            ...
            If Me.TipoFactura = "P" Then
                For i = 0 To tCust.Rows.Count - 1
                    If tCust.Rows(i)("Agregar") Then
                        DetallesProducto = VB.SysContab.ArticulosDB.GetDetails(tCust.Rows(i)("CodigoTemporal"), Me.TipoFactura)
                        If DetallesProducto.Cuenta = "" Or DetallesProducto.Cuenta = "0" Then
                            MsgBox("No se puede contabilizar la salida de almacen de la devolucion, porque no hay cuenta contable para el producto: " & DetallesProducto.Nombre, MsgBoxStyle.Critical, "STS-Contab")
                            Exit Sub
                        Else
                ...
                For i = 0 To tCust.Rows.Count - 1
                    If tCust.Rows(i)("Agregar") Then
                        ...
                        If rds.Tables(0).Rows(0)("Cuenta") = "" Or rds.Tables(0).Rows(0)("Cuenta") = "0" Then
                            MsgBox("No se puede contabilizar la salida de almacen por la devolucion, porque no hay cuenta contable para el producto: " & DetallesProducto.Nombre, MsgBoxStyle.Critical, "STS-Contab")
                            Exit Sub
                        Else
            ...
            DetallesProveedor = VB.SysContab.ProveedoresDB.GetDetails(Me.Proveedor)

            If DetallesProveedor.Cuenta.Trim = "" Then
                MsgBox("No se puede contabilizar la salida de almacen de la devolucion, porque no hay cuenta contable para el proveedor: " & DetallesProveedor.Nombre, MsgBoxStyle.Critical, "STS-Contab")
                Exit Sub
            End If


            Try
                'Grabar la devolucion
                DevolucionBodega.AddItem(Numero, Me.txtDevolucion.Text)
                VB.SysContab.BodegasDB.TransaccionBodega_Add(Bodega, "D", Numero, Me.dtpFecha.Value, Me.Proveedor)
                i = 0
                For i = 0 To tCust.Rows.Count - 1
                    If tCust.Rows(i)("Agregar") = True Then
                        DevolucionBodega.AddItemDetalle(Numero, tCust.Rows(i)("CodigoTemporal"), tCust.Rows(i)("Cantidad"))
                        Articulos.RestarExistencias(tCust.Rows(i)("CodigoTemporal"), tCust.Rows(i)("Cantidad"), tCust.Rows(i)("Tipo"))
                        If CDbl(CDbl(tCust.Rows(i)("Cantidad")) + CDbl(tCust.Rows(i)("CantidadDevuelta"))) = CDbl(tCust.Rows(i)("CantidadFacturada")) Then
                            Devolucion.UpdateItemEstado(Me.txtDevolucion.Text, tCust.Rows(i)("CodigoTemporal"), tCust.Rows(i)("Tipo"), 1)
                        End If
                        VB.SysContab.BodegasDB.Bodega_Articulos_Add(Bodega, tCust.Rows(i)("CodigoTemporal"), CDbl(tCust.Rows(i)("Cantidad")) * -1, CDbl(tCust.Rows(i)("Precio")), tCust.Rows(i)("Tipo")) 'IIf(tCust.Rows(i)("Tipo") = 1, "P", "A"))
                        VB.SysContab.BodegasDB.TransaccionBodegaDetalle_Add(Bodega, tCust.Rows(i)("CodigoTemporal"), "D", Numero, "S", CDbl(tCust.Rows(i)("Cantidad")), CDbl(tCust.Rows(i)("Precio")), Me.Proveedor, tCust.Rows(i)("Tipo")) 'IIf(tCust.Rows(i)("Tipo") = 1, "P", "A"))
                    End If
                Next
                ...
                plan = Plantilla.GetTipoPlantilla(3, 6).ToString
                ...
                CompNo = Comprobantes.AddComprobante(Detalles.TipoCompr, 1, _
                        "Comprobante de Devolucion al Proveedor #" & Me.Proveedor, _
                        EmpresasDB.GetDetails(EmpresaActual).MonedaBase, PeriodosDB.Activo(dtpFecha.Value), _
                        Me.dtpFecha.Value, 0, "", False, Me.Proveedor, "", 0, "D" & Numero, VB.SysContab.Rutinas.Fecha, 0, OrigenComprobantes.DEVOLUCION_PROVEEDOR)
                ...
                For x = 0 To Cuentas.GetUpperBound(0)
                    If Cuentas(x) <> "" Then
                        SumaMontos += Montos(x)
                        Comprobantes.AddComprobanteDetalles(CompNo, Cuentas(x), "", Montos(x), 0, Detalles.TipoCompr, "C", "D" & Numero, _
                            0, Me.dtpFecha.Value, 1)
                    End If
                Next
                ...
                Comprobantes.AddComprobanteDetalles(CompNo, ds.Tables("PlantillasDetalles").Rows(0).Item("Cuenta"), _
                    "", IVA, 0, Detalles.TipoCompr, "C", "", 0, Me.dtpFecha.Value, 1)
                If FormaPago.FormaPagoDias(Me.cFormapago) = 0 Then
                    ...
                    Comprobantes.AddComprobanteDetalles(CompNo, ds.Tables("PlantillasDetalles").Rows(2).Item("Cuenta"), _
                        "", SumaMontos + IVA, 0, Detalles.TipoCompr, "D", "", 0, Me.dtpFecha.Value, 1)
                Else
                    'Se agrega la cuenta del proveedor
                    Comprobantes.AddComprobanteDetalles(CompNo, DetallesProveedor.Cuenta, _
                        "", SumaMontos + IVA, 0, Detalles.TipoCompr, "D", "", 0, Me.dtpFecha.Value, 1)
                End If
