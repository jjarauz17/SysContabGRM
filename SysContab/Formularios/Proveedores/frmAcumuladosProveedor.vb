...
Public Class frmAcumuladosProveedor
    Inherits DevExpress.XtraEditors.XtraForm

    Private Shared ChildInstance As frmAcumuladosProveedor = Nothing

    Public Shared Function Instance() As frmAcumuladosProveedor
        If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
            ChildInstance = New frmAcumuladosProveedor()
        End If
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.dgAcumulados.Font = New System.Drawing.Font("Microsoft Sans Serif", 9.0!)
        ...
        Me.dgAcumulados.Size = New System.Drawing.Size(360, 375)
        ...
        Me.Label1.Text = "ACUMULADOS DEL PROVEEDOR:"
        ...
        Me.etDescripcion.Location = New System.Drawing.Point(224, 9)
        Me.etDescripcion.Name = "etDescripcion"
        Me.etDescripcion.Size = New System.Drawing.Size(752, 21)
        ...
        Me.ChartControl1.Size = New System.Drawing.Size(588, 375)
        Me.ChartControl1.TabIndex = 146
        '
        'nudAnio
        '
        ...
        'cmdEstadoCuenta
        '
        Me.cmdEstadoCuenta.Location = New System.Drawing.Point(16, 424)
        ...
        Me.Name = "frmAcumuladosProveedor"
...
#End Region
    ...
    Dim i As Integer
    Private Sub fmAcumuladosProveedor_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim Acumulados As New VB.SysContab.AcumuladosDB()

        'If TipoAcumulado = "C" Then
        DetallesProveedor = VB.SysContab.ProveedoresDB.GetDetails(Proveedor)
        ...
        nudAnio.Value = CDate(r.Fecha()).Year 'Now.Year
        ...
        'ds = Acumulados.GetList(Registro, TipoAcumulado)
        ds = Proveedores.Acumulados(Proveedor, nudAnio.Value)
        ds1 = Proveedores.AcumuladosDevoluciones(Proveedor, nudAnio.Value)
        ds2 = Proveedores.AcumuladosComprobantes(Proveedor, nudAnio.Value)

        'ds.Tables("Facturas_Compras").DefaultView.AllowDelete = False
        'ds.Tables("Facturas_Compras").DefaultView.AllowNew = False
        'ds.Tables("Facturas_Compras").DefaultView.AllowEdit = False

        'dgTasaCambio.DataSource = dsTasaCambio.Tables("TASA_CAMBIO").DefaultView

        dgAcumulados.ReadOnly = True
        'dgAcumulados.DataSource = ds.Tables("Facturas_Compras").DefaultView 'Acumulados.GetList(Registro).Tables("Acumulados").DefaultView
        'Tabla = ds.Tables("Facturas_Compras")

        'r.FormatGenerico(dgAcumulados, Tabla)

        MakeDataSet()
        Me.dgAcumulados.SetDataBinding(myDataSet, "Item")
        AddCustomDataTableStyle()

        dgAcumulados.Refresh()
    ...
    Private Sub DatosGrafico()
        Try
            ChartControl1.DataSource = ds.Tables("Facturas_Compras").DefaultView '' ObtieneDatos("JAR_GetAcumuladosProductos '" & Registro & "','P'," & EmpresaActual)
        ...
        Dim AcumuladosGrafico(,) As Object = New Object(,) _
            {{"CP", "C"}, _
            {ds.Tables("Facturas_Compras").Rows(0).Item("Mes"), CDbl(ds.Tables("Facturas_Compras").Rows(0).Item("Monto")) - CDbl(ds1.Tables("Facturas_Compras").Rows(0).Item("Monto")) + CDbl(ds2.Tables("Facturas_Compras").Rows(0).Item("Monto"))}, _
            {ds.Tables("Facturas_Compras").Rows(1).Item("Mes"), CDbl(ds.Tables("Facturas_Compras").Rows(1).Item("Monto")) - CDbl(ds1.Tables("Facturas_Compras").Rows(1).Item("Monto")) + CDbl(ds2.Tables("Facturas_Compras").Rows(1).Item("Monto"))}, _
            {ds.Tables("Facturas_Compras").Rows(2).Item("Mes"), CDbl(ds.Tables("Facturas_Compras").Rows(2).Item("Monto")) - CDbl(ds1.Tables("Facturas_Compras").Rows(2).Item("Monto")) + CDbl(ds2.Tables("Facturas_Compras").Rows(2).Item("Monto"))}, _
            {ds.Tables("Facturas_Compras").Rows(3).Item("Mes"), CDbl(ds.Tables("Facturas_Compras").Rows(3).Item("Monto")) - CDbl(ds1.Tables("Facturas_Compras").Rows(3).Item("Monto")) + CDbl(ds2.Tables("Facturas_Compras").Rows(3).Item("Monto"))}, _
            {ds.Tables("Facturas_Compras").Rows(4).Item("Mes"), CDbl(ds.Tables("Facturas_Compras").Rows(4).Item("Monto")) - CDbl(ds1.Tables("Facturas_Compras").Rows(4).Item("Monto")) + CDbl(ds2.Tables("Facturas_Compras").Rows(4).Item("Monto"))}, _
            {ds.Tables("Facturas_Compras").Rows(5).Item("Mes"), CDbl(ds.Tables("Facturas_Compras").Rows(5).Item("Monto")) - CDbl(ds1.Tables("Facturas_Compras").Rows(5).Item("Monto")) + CDbl(ds2.Tables("Facturas_Compras").Rows(5).Item("Monto"))}, _
            {ds.Tables("Facturas_Compras").Rows(6).Item("Mes"), CDbl(ds.Tables("Facturas_Compras").Rows(6).Item("Monto")) - CDbl(ds1.Tables("Facturas_Compras").Rows(6).Item("Monto")) + CDbl(ds2.Tables("Facturas_Compras").Rows(6).Item("Monto"))}, _
            {ds.Tables("Facturas_Compras").Rows(7).Item("Mes"), CDbl(ds.Tables("Facturas_Compras").Rows(7).Item("Monto")) - CDbl(ds1.Tables("Facturas_Compras").Rows(7).Item("Monto")) + CDbl(ds2.Tables("Facturas_Compras").Rows(7).Item("Monto"))}, _
            {ds.Tables("Facturas_Compras").Rows(8).Item("Mes"), CDbl(ds.Tables("Facturas_Compras").Rows(8).Item("Monto")) - CDbl(ds1.Tables("Facturas_Compras").Rows(8).Item("Monto")) + CDbl(ds2.Tables("Facturas_Compras").Rows(8).Item("Monto"))}, _
            {ds.Tables("Facturas_Compras").Rows(9).Item("Mes"), CDbl(ds.Tables("Facturas_Compras").Rows(9).Item("Monto")) - CDbl(ds1.Tables("Facturas_Compras").Rows(9).Item("Monto")) + CDbl(ds2.Tables("Facturas_Compras").Rows(9).Item("Monto"))}, _
            {ds.Tables("Facturas_Compras").Rows(10).Item("Mes"), CDbl(ds.Tables("Facturas_Compras").Rows(10).Item("Monto")) - CDbl(ds1.Tables("Facturas_Compras").Rows(10).Item("Monto")) + CDbl(ds2.Tables("Facturas_Compras").Rows(10).Item("Monto"))}, _
            {ds.Tables("Facturas_Compras").Rows(11).Item("Mes"), CDbl(ds.Tables("Facturas_Compras").Rows(11).Item("Monto")) - CDbl(ds1.Tables("Facturas_Compras").Rows(11).Item("Monto")) + CDbl(ds2.Tables("Facturas_Compras").Rows(11).Item("Monto"))}}
    ...
    Private Sub frmAcumuladosProveedor_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    ...
    Private Sub cmdEstadoCuenta_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEstadoCuenta.Click
        Dim f As frmEstadoCuentaProveedor = f.Instance
        f.etProveedor.Text = DetallesProveedor.Codigo
    ...
    Private Sub nudAnio_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles nudAnio.ValueChanged
        If Proveedor = Nothing Or Proveedor = "Vacio" Then
            Exit Sub
        Else
            ...
            ds1 = Proveedores.AcumuladosDevoluciones(Proveedor, nudAnio.Value)
            ds2 = Proveedores.AcumuladosComprobantes(Proveedor, nudAnio.Value)
            'dgAcumulados.DataSource = ds.Tables("Facturas_Compras").DefaultView
            'Tabla = ds.Tables("Facturas_Compras")
            'r.FormatGenerico(dgAcumulados, Tabla)
    ...
    Private Sub MakeDataSet()
        ...
        For i = 0 To ds.Tables("Facturas_Compras").Rows.Count - 1
            newRow1 = tCust.NewRow
            tCust.Rows.Add(newRow1)
            tCust.Rows(i)("Mes") = ds.Tables("Facturas_Compras").Rows(i).Item("Mes")
            tCust.Rows(i)("Monto") = CDbl(CDbl(ds.Tables("Facturas_Compras").Rows(i).Item("Monto")) - CDbl(ds1.Tables("Facturas_Compras").Rows(i).Item("Monto")) + CDbl(ds2.Tables("Facturas_Compras").Rows(i).Item("Monto"))).ToString(Round)
