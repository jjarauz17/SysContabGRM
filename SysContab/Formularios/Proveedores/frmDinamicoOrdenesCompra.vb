...
Public Class frmDinamicoOrdenesCompra
    ...
    Private Sub LlenarGrid()
        ...
        Dim DT As DataTable = VB.SysContab.Ordenes_ComprasDB.ReporteDinamico(Desde.DateTime.Date.AddMonths(2).Date,
                                                    Hasta.DateTime.Date,
                                                    cbMoneda.EditValue)
        ...
        iPivotGrid.Fields("Descripcion").Area = DevExpress.XtraPivotGrid.PivotArea.RowArea

        iPivotGrid.Fields("Sub Total").Area = DevExpress.XtraPivotGrid.PivotArea.DataArea
        iPivotGrid.Fields("Impuesto").Area = DevExpress.XtraPivotGrid.PivotArea.DataArea
        ...
        iPivotGrid.Fields("Descripcion").Width = 250
    ...
    Private Sub bGrafico_Click(sender As Object, e As EventArgs) Handles bGrafico.Click
        With frmGraficosDinamicos
            ...
            .etTitulo.Text = "Gráfico Dinámico de Ordenes de Compra"
    ...
    Private Sub bExportar_Click(sender As Object, e As EventArgs) Handles bExportar.Click
        frmExportarImprimir.Mostrar(iPivotGrid, "Dinámico de Ordenes de Compra")
    End Sub

    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        ShowSplash("Generando Reporte...")
        Dim DT As DataTable = VB.SysContab.Ordenes_ComprasDB.ReporteDinamico(Desde.DateTime.Date,
                                                    Hasta.DateTime.Date,
                                                    cbMoneda.EditValue)
        iPivotGrid.DataSource = DT
        HideSplash()
