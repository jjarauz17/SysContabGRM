Public Class frmFacturasComprasAlmacen
    Inherits DevExpress.XtraEditors.XtraForm

    Private Shared ChildInstance As frmFacturasComprasAlmacen = Nothing

    Public Shared Function Instance() As frmFacturasComprasAlmacen
        If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
            ChildInstance = New frmFacturasComprasAlmacen()
        End If
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(1000, 391)
        ...
        Me.dgFacturas.Size = New System.Drawing.Size(984, 364)
        ...
        Me.GroupBox2.Size = New System.Drawing.Size(480, 60)
        ...
        'cmdNuevo
        '
        Me.cmdNuevo.Location = New System.Drawing.Point(384, 17)
        ...
        Me.dtpFecha1.TabIndex = 169
        '
        'frmFacturasComprasAlmacen
        '
        ...
        Me.Name = "frmFacturasComprasAlmacen"
...
#End Region
    ...
    Private Sub frmFacturasComprasList_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ds = Facturas.FacturasCompraAlmacen(cbProveedor.SelectedValue, Fecha, Fecha1, 0, 2, cbTipo.SelectedValue, 0, Me.cbOrigen.SelectedIndex, 0)
    ...
    Private Sub cbProveedor_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbProveedor.SelectedValueChanged
        ...
        ds = Facturas.FacturasCompraAlmacen(cbProveedor.SelectedValue, Fecha, Fecha1, Me.cbMeses.SelectedIndex, 2, cbTipo.SelectedValue, 0, Me.cbOrigen.SelectedIndex, 0)
        Me.dgFacturas.DataSource = ds.Tables("Facturas_Compra").DefaultView
        'End If
    End Sub
    ...
    Private Sub cBoxFecha_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cBoxFecha.CheckedChanged
        ...
        ds = Facturas.FacturasCompraAlmacen(cbProveedor.SelectedValue, Fecha, Fecha1, cbMeses.SelectedIndex, 2, cbTipo.SelectedValue, 0, Me.cbOrigen.SelectedIndex, 0)
        Me.dgFacturas.DataSource = ds.Tables("Facturas_Compra").DefaultView
    End Sub
