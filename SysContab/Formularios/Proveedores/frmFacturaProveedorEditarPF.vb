...
Namespace DataGridTextBoxCombo
    Public Class frmFacturaProveedorEditarPF
        Inherits DevExpress.XtraEditors.XtraForm

        Private Shared ChildInstance As frmFacturaProveedorEditarPF = Nothing

        Public Shared Function Instance() As frmFacturaProveedorEditarPF
            If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
                ChildInstance = New frmFacturaProveedorEditarPF()
            End If
...
#Region " Código generado por el Diseñador de Windows Forms "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.Name = "frmFacturaProveedorEditarPF"
...
#End Region
        ...
        Private Sub frmFacturaProveedorEditarPF_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Private Sub frmFacturaProveedorEditar_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
            ...
            f.ds = Proveedores.FacturasPagar(f.Fecha1, f.Fecha2, f.cbProveedores.SelectedValue, f.cbEstado.SelectedValue)
