...
Public Class frmReporteAuxiliarMercaderiaTransito
    ...
    Sub Cargar(fDesde As Date, fHasta As Date)
        iGrid.DataSource =
            VB.SysContab.Ordenes_ComprasDB.MercaderiaTransito(fDesde, fHasta)
    End Sub

    Sub Grid()
        iVista.PopulateColumns()
        FormatoGrid(iVista, 2, 0, False)
        iVista.Columns("No. Pedido").Group()
    ...
    Private Sub SimpleButton8_Click(sender As Object, e As EventArgs) Handles SimpleButton8.Click
        ...
        VistaPreviaDX(rpt,
                      VB.SysContab.Ordenes_ComprasDB.MercaderiaTransito(
                      Desde.DateTime.Date,
                      Hasta.DateTime.Date),
                      "Reporte Auxliar de Marcaderia en Transito")
