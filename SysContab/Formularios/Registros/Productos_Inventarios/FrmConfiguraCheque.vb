...
Public Class FrmConfiguraCheque
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmConfiguraCheque))
        ...
        Me.DockPanel1.Location = New System.Drawing.Point(551, 62)
...
#End Region
    ...
    Private Sub FrmConfiguraCheque_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim DT As DataTable = ObtieneDatos("SELECT Impresa,Cambio, ChequeD FROM Formatos Where Tipo = " & Tipo & " and Empresa = " & EmpresaActual)
        ...
        Try
            Dim Data() As Byte
            If Tipo = 0 Then
                Data = CType(ObtieneDatos("SELECT ChequeD FROM Catalogo_Bancos WHERE Codigo = " & Codigos & " AND EMPRESA = " & EmpresaActual).Rows(0).Item(0), Byte())
                cmbimpresa.Visible = False
                cmbcambio.Visible = False
                LabelControl4.Visible = False
                LabelControl5.Visible = False
            Else
                Data = CType(DT.Rows(0)("ChequeD"), Byte())
            End If

            Dim Tamano As Integer = Data.GetUpperBound(0)
            Dim Cadena As String = Application.StartupPath & "\RptCheque.repx"
        ...
        If Tipo = 0 Then
            ...
            Nombre = "CHEQUE"
        ElseIf Tipo = 1 Then
            Rep = New RptFormatoAlcaldia
            Nombre = "RETENCION ALCALDIA"
        ElseIf Tipo = 2 Then
            'Rep = New RptFacturaNew
            Rep = New rptFormatoFactura
            Nombre = "FACTURA DE CONTADO"
        ElseIf Tipo = 3 Then
            Rep = New RptRecibo
            Nombre = "RECIBO OFICIAL DE CAJA"
        ElseIf Tipo = 4 Then
            ' Rep = New RptCotizacionNew
            Rep = New rptProformaNew
            Nombre = "COTIZACIONES DE CLIENTE"
        ElseIf Tipo = 5 Then
            Rep = New RptRetencion
            Nombre = "FORMATO DE RETENCIONES"
        ElseIf Tipo = 6 Then
            Rep = New rptNotasProveedores
            Nombre = "NOTAS DE DEBITO/CREDITO CLIENTES"
        ElseIf Tipo = 7 Then
            Rep = New Rpt_Produccion
            Nombre = "ORDEN DE PRODUCCION"
        ElseIf Tipo = 9 Then
            Rep = New RptFacturaNewCredito
            Nombre = "FACTURA DE CREDITO"
        ElseIf Tipo = 10 Then
            Rep = New rptRemisiones
            Nombre = "REMISIONES DE BODEGA"
        ElseIf Tipo = 11 Then
            Rep = New rptNotaTraslado
            Nombre = "NOTA DE TRASLADO"
        ElseIf Tipo = 12 Then
            Rep = New rptOrdenEntrega
            Nombre = "ORDEN DE ENTREGA"
        ElseIf Tipo = 15 Then
            Rep = New rptOrdenCompra    'Orden de Compra
            Nombre = "ORDEN DE COMPRA"
        ElseIf Tipo = 16 Then
            Rep = New rtpCodigoBarra
            Nombre = "CODIGO DE BARRA"
        ElseIf Tipo = 17 Then
            Rep = New rptComprobantesALL
            Nombre = "COMPROBANTE CONTABLE"
        ElseIf Tipo = 18 Then
            Rep = New rptOrdenPago      'Orden de Pago
            Nombre = "ORDEN DE PAGO"
        ElseIf Tipo = 19 Then
            Rep = New rptOrdenCompra    'Pedido de Bodega
            Nombre = "PEDIDOS DE BODEGA"
        ElseIf Tipo = 20 Then
            Rep = New rptEstadoResultado    'Estado de Resultado Consolidado
            Nombre = "ESTADO DE RESULTADO"
        ElseIf Tipo = 21 Then
            Rep = New rptEstadoCuentaCliente_Email    'Estado de Cuenta Enviar por E-Mail
            Nombre = "ESTADO DE CUENTA CLIENTE"
        ElseIf Tipo = 22 Then
            Rep = New RptAnalisisAntiguedad    'Estado de Antiguedad de Saldos de Clientes
            Nombre = "ANTIGUEDAD DE SALDO EN CLIENTES"
        ElseIf Tipo = 23 Then
            Rep = New RptAnalisisAntiguedadCxP    'Estado de Antiguedad de Saldos de Proveedores
            Nombre = "ANTIGUEDAD DE SALDO EN PROVEEDORES"
        ElseIf Tipo = 24 Then
            Rep = New rptEntrada_Bodega    'Movimientos de Inventarios
            Nombre = "MOVIMIENTOS DE INVENTARIO"
        ElseIf Tipo = 25 Then
            Rep = New rptTrasladoBodegas    'Traslados de Bodegas
            Nombre = "TRASLADO DE BODEGA"
        ElseIf Tipo = 26 Then
            Rep = New rptProyecto    'Formato impreso de Proyectos
            Nombre = "PROYECTOS"
        ElseIf Tipo = 27 Then
            Rep = New RptEstadoCuentaCliente    'Formato impreso de Cuentas por Cobrar
            Nombre = "CUENTAS POR COBRAR"
        ElseIf Tipo = 28 Then
            Rep = New rptOrdenTrabajo    'Formato impreso de Orden de trabajo
    ...
    Private Sub CommandBarItem33_ItemClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles CommandBarItem33.ItemClick
        ...
        Dim _FormatoNombre As New SqlParameter("@Nombre", SqlDbType.NVarChar)
        ...
        cmd.Parameters.Add(_FormatoNombre)
    ...
    Private Sub cmdoriginal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdoriginal.Click
        ...
        ElseIf Tipo = 2 Then
            ...
            Dim Rep As New rptFormatoFactura
            Me.XrDesignPanel1.OpenReport(Rep)
        ElseIf Tipo = 3 Then
        ...
        ElseIf Tipo = 4 Then
            ...
            Dim Rep As New rptProformaNew
            Me.XrDesignPanel1.OpenReport(Rep)
        ElseIf Tipo = 5 Then
            Dim Rep As New RptRetencion
            Me.XrDesignPanel1.OpenReport(Rep)
        ElseIf Tipo = 6 Then
            Dim Rep As New rptNotasProveedores
            Me.XrDesignPanel1.OpenReport(Rep)
        ElseIf Tipo = 7 Then
            Dim Rep As New Rpt_Produccion
            Me.XrDesignPanel1.OpenReport(Rep)
        ...
        ElseIf Tipo = 20 Then
            ...
            Me.XrDesignPanel1.OpenReport(Rep)
        ElseIf Tipo = 21 Then
            Dim Rep As New rptEstadoCuentaCliente_Email  'Estado de Cuenta Enviar por E-Mail
            Me.XrDesignPanel1.OpenReport(Rep)
        ElseIf Tipo = 22 Then
            Dim Rep As New RptAnalisisAntiguedad  'Estado de Antiguedad de Saldos de Clientes
            Me.XrDesignPanel1.OpenReport(Rep)
        ElseIf Tipo = 23 Then
            Dim Rep As New RptAnalisisAntiguedadCxP  'Estado de Antiguedad de Saldos de Proveedores
            Me.XrDesignPanel1.OpenReport(Rep)
        ElseIf Tipo = 24 Then
            Dim Rep As New rptEntrada_Bodega    'Estado de Antiguedad de Saldos de Proveedores
            Me.XrDesignPanel1.OpenReport(Rep)
        ElseIf Tipo = 25 Then
            Dim Rep As New rptTrasladoBodegas    'Estado de Antiguedad de Saldos de Proveedores
            Me.XrDesignPanel1.OpenReport(Rep)
        ElseIf Tipo = 26 Then
