...
Public Class frmSalidaBodegaList
    Inherits DevExpress.XtraEditors.XtraForm

    Private Shared ChildInstance As frmSalidaBodegaList = Nothing

    Public Shared Function Instance() As frmSalidaBodegaList
        If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
            ChildInstance = New frmSalidaBodegaList()
        End If
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.dgFacturasClientes.Size = New System.Drawing.Size(1000, 360)
...
#End Region
    ...
    Dim Salida As New VB.SysContab.SalidaBodegaDB()
    ...
    Private Sub frmListaFacturaClientes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dgFacturasClientes.DataSource = ds.Tables("SalidaBodega").DefaultView
        Tabla = ds.Tables("SalidaBodega")

        r.FormatGenerico(dgFacturasClientes, Tabla)

        dgFacturasClientes.CaptionText = "Salida de Bodega"

        r.ComboAutoComplete(Me.cbClientes)

        Me.Text = "S a l i d a  d e  B o d e g a"
        Me.Refresh()
    ...
    Private Sub checkBoxFecha_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles checkBoxFecha.CheckedChanged
        ...
        Try
            ...
            End If
            ds = Salida.GetList(Me.txtFactura.Text, Me.cbClientes.SelectedValue, Fecha1, Fecha2)
            dgFacturasClientes.DataSource = ds.Tables("SalidaBodega").DefaultView
    ...
    Private Sub cmdDevoluciones_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDevoluciones.Click
        Dim f As DataGridTextBoxCombo.frmSalidaBodegaVer = f.Instance
        f.txtSalida.Text = Me.dgFacturasClientes.Item(Me.dgFacturasClientes.CurrentRowIndex, 0)
        f.MdiParent = Me.MdiParent
        f.Show()
        f.WindowState = FormWindowState.Maximized
    End Sub
    ...
    Private Sub frmSalidaBodegaList_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
