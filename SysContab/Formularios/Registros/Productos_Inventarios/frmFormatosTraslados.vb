...
Public Class frmFormatosTraslados
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    Friend WithEvents cbTipoFormato As DevExpress.XtraEditors.LookUpEdit
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cbTipoFormato = New DevExpress.XtraEditors.LookUpEdit()
        ...
        CType(Me.cbTipoFormato.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.SuspendLayout()
        '
        'XrDesignPanel1
        '
        ...
        Me.XrDesignPanel1.Size = New System.Drawing.Size(739, 467)
        ...
        Me.barDockControlTop.Size = New System.Drawing.Size(1008, 62)
        '
        ...
        Me.barDockControlRight.Location = New System.Drawing.Point(1008, 62)
        ...
        Me.cmdoriginal.Image = CType(resources.GetObject("cmdoriginal.Image"), System.Drawing.Image)
        Me.cmdoriginal.Location = New System.Drawing.Point(889, 22)
        ...
        Me.AutoHideContainer1.Location = New System.Drawing.Point(989, 62)
        ...
        Me.DockPanel1.Location = New System.Drawing.Point(789, 62)
        Me.DockPanel1.Name = "DockPanel1"
        Me.DockPanel1.OriginalSize = New System.Drawing.Size(200, 478)
        Me.DockPanel1.SavedDock = DevExpress.XtraBars.Docking.DockingStyle.Right
        Me.DockPanel1.SavedIndex = 0
        Me.DockPanel1.Size = New System.Drawing.Size(200, 467)
        ...
        Me.DockPanel1_Container.Size = New System.Drawing.Size(192, 440)
        ...
        Me.PropertyGridDockPanel1.Location = New System.Drawing.Point(739, 62)
        ...
        'cbTipoFormato
        '
        Me.cbTipoFormato.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
            Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.cbTipoFormato.Location = New System.Drawing.Point(557, 36)
        Me.cbTipoFormato.MenuManager = Me.XrDesignBarManager1
        Me.cbTipoFormato.Name = "cbTipoFormato"
        Me.cbTipoFormato.Properties.Appearance.Font = New System.Drawing.Font("Tahoma", 9.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.cbTipoFormato.Properties.Appearance.Options.UseFont = True
        Me.cbTipoFormato.Properties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() {New DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)})
        Me.cbTipoFormato.Size = New System.Drawing.Size(326, 20)
        Me.cbTipoFormato.TabIndex = 20
        '
        'LabelControl6
        '
        ...
        Me.LabelControl6.Location = New System.Drawing.Point(466, 42)
        Me.LabelControl6.Name = "LabelControl6"
        Me.LabelControl6.Size = New System.Drawing.Size(85, 14)
        Me.LabelControl6.TabIndex = 21
        Me.LabelControl6.Text = "Tipo Formato:"
        '
        'FrmFormatos
        '
        ...
        Me.Controls.Add(Me.cbTipoFormato)
        ...
        CType(Me.cbTipoFormato.Properties, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Sub Cargar()
        ...
        Try
            Dim Data() As Byte = CType(ObtieneDatos("sp_sel_Bodegas", cbTipoFormato.EditValue, EmpresaActual).Rows.Item(0)("Formato_Traslado"), Byte())

            Dim Tamano As Integer = Data.GetUpperBound(0)
            Dim Cadena As String = Application.StartupPath & "\rptTraslado.repx"
        ...
        End Try
        '
        Dim rpt As New rptTrasladoBodegas

        If Temp Then
            Try
                rpt.LoadLayout(Application.StartupPath & "\rptTraslado.repx")
            Catch ex1 As Exception
                XtraMsg(ex1.Message, MessageBoxIcon.Error)
            End Try
        End If
    ...
    Private Sub FrmConfiguraCheque_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'Dim DT As DataTable = ObtieneDatos("SELECT Impresa, Cambio FROM Formatos Where Tipo = " & Tipo & " and Empresa = " & EmpresaActual)
        'Try
    ...
    Sub CargarCombos()
        'Combo(cbTipoFormato, db_TipoFacturas.Listar(0))
        'cbTipoFormato.ItemIndex = 0

        GetBodegasList(cbTipoFormato)
        cbTipoFormato.ItemIndex = 0
    ...
    Private Sub CommandBarItem33_ItemClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles CommandBarItem33.ItemClick
        ...
        If File.Exists(Application.StartupPath & "\rptTraslado.repx") Then
            Kill(Application.StartupPath & "\rptTraslado.repx")
        End If

        Me.XrDesignPanel1.FileName = Application.StartupPath & "\rptTraslado.repx"
        Me.XrDesignPanel1.SaveReport()

        Dim cn As New SqlConnection(VB.SysContab.Rutinas.AbrirConexion)
        Dim cmd As New SqlCommand("sp_upd_Bodegas", cn)
        cmd.CommandType = CommandType.StoredProcedure

        Dim _Bodega As New SqlParameter("@Bodega", SqlDbType.NVarChar)
        Dim _Empresa As New SqlParameter("@Empresa", SqlDbType.Int)
        Dim _Data As New SqlParameter("@Formato", SqlDbType.VarBinary)

        Dim Archivo As New FileStream(Application.StartupPath & "\rptTraslado.repx",
                            FileMode.Open, FileAccess.Read)
        Dim ArchivoData(Archivo.Length() - 1) As Byte
        Archivo.Read(ArchivoData, 0, ArchivoData.Length)
        Archivo.Close()

        _Bodega.Value = cbTipoFormato.EditValue
        _Empresa.Value = EmpresaActual
        _Data.Value = ArchivoData

        cmd.Parameters.Add(_Bodega)
        cmd.Parameters.Add(_Empresa)
        cmd.Parameters.Add(_Data)
    ...
    Private Sub cmdoriginal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdoriginal.Click
        Dim Rep As New rptTrasladoBodegas
        Me.XrDesignPanel1.OpenReport(Rep)
    End Sub

    Private Sub cbTipoFormato_EditValueChanged(sender As Object, e As EventArgs) Handles cbTipoFormato.EditValueChanged
        Cargar()
    End Sub
End Class
