Public Class frmAreasConsumo
    Inherits DevExpress.XtraEditors.XtraForm

    Private Shared ChildInstance As frmAreasConsumo = Nothing

    Public Shared Function Instance() As frmAreasConsumo
        If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
            ChildInstance = New frmAreasConsumo()
        End If
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GroupBox1.Location = New System.Drawing.Point(24, 452)
        ...
        Me.dgGruposInventario.Size = New System.Drawing.Size(976, 404)
...
#End Region
    ...
    Private Sub frmAreasConsumo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ''r.FormularioColor(Me)

        RolesDB.UsuarioAcciones(GroupBox1)
        ''
        ds = GruposCC.AreasList
        ...
        dgGruposInventario.CaptionText = "Areas de Consumo"

        Me.Text = "Areas de Consumo"
    ...
    Private Sub cmdNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdNuevo.Click
        Dim f As frmAgregarAreaConsumo = frmAgregarAreaConsumo.Instance
        f.MdiParent = Me.MdiParent
        f.Show()
    End Sub

    Private Sub cmdModificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdModificar.Click
        Dim f As frmAreaConsumoEditar = frmAreaConsumoEditar.Instance
        f.MdiParent = Me.MdiParent
    ...
    Private Sub frmAreasConsumo_MouseEnter(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.MouseEnter
        '
    End Sub
    ...
    Private Sub cmdAyuda_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdAyuda.Click
        Help.ShowHelp(Me, "Ayuda/RegISAreas.chm")
    End Sub
End Class
