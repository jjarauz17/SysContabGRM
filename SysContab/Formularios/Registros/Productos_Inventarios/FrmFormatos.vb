...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cmdoriginal.ImageOptions.Image = CType(resources.GetObject("cmdoriginal.ImageOptions.Image"), System.Drawing.Image)
        ...
        Me.DockPanel1_Container.Size = New System.Drawing.Size(191, 440)
        ...
        Me.PropertyGridDockPanel1_Container.Size = New System.Drawing.Size(241, 440)
...
#End Region
    ...
    Sub Cargar()
        ...
        Try
            Dim Data() As Byte = CType(db_TipoFacturas.Listar(cbTipoFormato.EditValue).Rows.Item(0)("Formato"), Byte())
        ...
        Tipo = cbTipoFormato.EditValue
        Nombre = cbTipoFormato.Text

        If Temp Then
            Try
                rpt.LoadLayout(Application.StartupPath & "\rptFormato.repx")
    ...
    Private Sub CommandBarItem33_ItemClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles CommandBarItem33.ItemClick
        ...
        Dim cmd As New SqlCommand("sp_upd_TipoFacturas", cn)
        cmd.CommandType = CommandType.StoredProcedure

        Dim _Codigo As New SqlParameter("@IdTipo", SqlDbType.Int)
        ...
        _Codigo.Value = cbTipoFormato.EditValue
        _Empresa.Value = EmpresaActual
        _Nombre.Value = cbTipoFormato.Text
