...
Namespace DataGridTextBox
    Public Class frmComprobanteNotaCredito
        Inherits DevExpress.XtraEditors.XtraForm

        Private Shared ChildInstance As frmComprobanteNotaCredito = Nothing

        Public Shared Function Instance() As frmComprobanteNotaCredito
            If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
                ChildInstance = New frmComprobanteNotaCredito()
            End If
...
#Region " Código generado por el Diseñador de Windows Forms "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.GroupBox1.Controls.AddRange(New System.Windows.Forms.Control() {Me.txtChequeNombre, Me.Label9, Me.Label8, Me.etSubTotal, Me.etIva, Me.etPlantilla, Me.txtCodigoProveedor, Me.txtNotaCredito, Me.Label5, Me.txtProvID, Me.txtBanco, Me.txtProv, Me.lblTotal, Me.Label39, Me.Label38, Me.lblDebTotal, Me.lblCredTotal, Me.etTotalT, Me.txtConcepto, Me.Label4, Me.lblProv, Me.lblBanco, Me.xddlBanco, Me.xddlProv, Me.txtValor, Me.Label6, Me.dgFacturacionCliente, Me.txtFact, Me.lblFact, Me.txtCheque, Me.lblCheque, Me.dtFecha, Me.Label1, Me.txtDevolucion})
            ...
            'Label8
            '
            Me.Label8.BackColor = System.Drawing.Color.FromArgb(CType(189, Byte), CType(210, Byte), CType(210, Byte))
            Me.Label8.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
            Me.Label8.ForeColor = System.Drawing.Color.FromArgb(CType(0, Byte), CType(0, Byte), CType(192, Byte))
            Me.Label8.Location = New System.Drawing.Point(624, 16)
            Me.Label8.Name = "Label8"
            Me.Label8.Size = New System.Drawing.Size(96, 24)
            Me.Label8.TabIndex = 1017
            ...
            Me.etSubTotal.Location = New System.Drawing.Point(224, 368)
            ...
            Me.etIva.Location = New System.Drawing.Point(160, 368)
            Me.etIva.Name = "etIva"
            ...
            Me.etPlantilla.Location = New System.Drawing.Point(344, 368)
            ...
            Me.txtCodigoProveedor.Location = New System.Drawing.Point(752, 72)
            ...
            Me.txtNotaCredito.Location = New System.Drawing.Point(752, 96)
            ...
            Me.Label5.Location = New System.Drawing.Point(624, 96)
            ...
            Me.txtProvID.Location = New System.Drawing.Point(616, 72)
            ...
            Me.dgFacturacionCliente.Location = New System.Drawing.Point(12, 120)
            ...
            Me.dgFacturacionCliente.Size = New System.Drawing.Size(884, 184)
            ...
            Me.lblFact.Location = New System.Drawing.Point(368, 24)
            ...
            Me.lblCheque.Location = New System.Drawing.Point(368, 48)
            ...
            Me.txtChequeNombre.TabIndex = 1021
            ...
            Me.Label9.Text = "Pagar cheque a nombre:"
            '
            'frmComprobanteNotaCredito
            '
            ...
            Me.Name = "frmComprobanteNotaCredito"
...
#End Region
        ...
        Private Sub frmComprobanteFCContado_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            dsDetalle = Devoluciones.DevolucionDetalle(Me.txtDevolucion.Text)

            'Cambios
            'lblCheque.Text = ds.Tables("PlantillasDetalles").Rows(1).Item("Var")
            lblCheque.Text = "No. Cheque:"

            lblProv.Text = "Cliente:" 'ds.Tables("PlantillasDetalles").Rows(0).Item("Etiqueta")
            'Cambios
            ...
            Me.txtChequeNombre.Text = Me.txtProv.Text
            ...
            'tCust.Rows(0)("Monto") = CDbl(CDbl(Me.etSubTotal.Text) * CDbl((CDbl(ConfigDetalles.IVA) / 100.0))).ToString(Round)
            tCust.Rows(1)("Monto") = CDbl(Me.txtValor.Text).ToString(Round)
            ...
            For filas = 1 To tCust.Rows.Count - 1
            ...
            tCust.Rows(0)("Monto") = CDbl(Iva).ToString(Round) 'CDbl(CDbl(Debito) * CDbl((CDbl(ConfigDetalles.IVA) / 100.0))).ToString(Round)
            Debito = Debito + CDbl(tCust.Rows(0)("Monto"))
        ...
        Private Sub MakeDataSet()
            ...
            dsDetalleArticulo = VB.SysContab.ArticulosDB.GetDetails(dsDetalle.Tables("Facturas_Ventas").Rows(0).Item("Item"), "P")
            CatalogoDetalle = CatalogoDB.GetDetails(dsDetalleArticulo.Cuenta)
            tCust.Rows(j)("Cuenta") = dsDetalleArticulo.Cuenta
            tCust.Rows(j)("Catalogo") = CatalogoDetalle.Nombre

            'Monto = CDbl(dsDetalle.Tables("Facturas_Compras").Rows(0).Item("Item_Cantidad_Almacen")) * CDbl(dsDetalle.Tables("Facturas_Compras").Rows(0).Item("Item_Costo")) - CDbl(dsDetalle.Tables("Facturas_Compras").Rows(0).Item("Item_Descuento"))
            Monto = CDbl(dsDetalle.Tables("Facturas_Ventas").Rows(0).Item("Cantidad")) * CDbl(dsDetalle.Tables("Facturas_Ventas").Rows(0).Item("Precio")) - (CDbl(dsDetalle.Tables("Facturas_Ventas").Rows(0).Item("Cantidad")) * CDbl(dsDetalle.Tables("Facturas_Ventas").Rows(0).Item("Precio")) * CDbl(dsDetalle.Tables("Facturas_Ventas").Rows(0).Item("Descuento")) / 100.0)

            Iva = 0
            Iva = CDbl(CDbl(dsDetalle.Tables("Facturas_Ventas").Rows(0).Item("Iva")).ToString(Round))
            ...
            For i = 1 To dsDetalle.Tables("Facturas_Ventas").Rows.Count - 1
                dsDetalleArticulo = VB.SysContab.ArticulosDB.GetDetails(dsDetalle.Tables("Facturas_Ventas").Rows(i).Item("Item"), "P")
                Monto = CDbl(dsDetalle.Tables("Facturas_Ventas").Rows(i).Item("Cantidad")) * CDbl(dsDetalle.Tables("Facturas_Ventas").Rows(i).Item("Precio")) - (CDbl(dsDetalle.Tables("Facturas_Ventas").Rows(i).Item("Cantidad")) * CDbl(dsDetalle.Tables("Facturas_Ventas").Rows(i).Item("Precio")) * CDbl(dsDetalle.Tables("Facturas_Ventas").Rows(i).Item("Descuento")) / 100.0)
                Iva = Iva + CDbl(CDbl(dsDetalle.Tables("Facturas_Ventas").Rows(i).Item("Iva")).ToString(Round))
                'tCust.Rows(i)("Monto") = CDbl(Monto).ToString(Round)

                For k = 2 To tCust.Rows.Count - 1
        ...
        Private Sub cmdAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAceptar.Click
            ...
            If Validar() = True Then
                Try
                    ...
                    CompNo = Comprobantes.AddComprobante(TipoCompr, txtTasaCambio.Text, txtConcepto.Text, EmpresasDB.GetDetails(EmpresaActual).MonedaBase, PeriodosDB.Activo(dtFecha.Value), dtFecha.Value, 0, Me.txtChequeNombre.Text, False, 0, "", 0, "", VB.SysContab.Rutinas.Fecha, 0, OrigenComprobantes.NOTA_CREDITO)
                    ...
                    For filas = 0 To tCust.Rows.Count - 1
                        ...
                        Comprobantes.AddComprobanteDetalles(CompNo, tCust.Rows(filas)("Cuenta"), tCust.Rows(filas)("Descripcion").ToString, tCust.Rows(filas)("Monto"), txtCheque.Text, TipoCompr, Tipo, Me.txtFact.Text, 0, Me.dtFecha.Value, 1)
                ...
                Dim f As frmBancosContabilizarNotaCredito = f.Instance
