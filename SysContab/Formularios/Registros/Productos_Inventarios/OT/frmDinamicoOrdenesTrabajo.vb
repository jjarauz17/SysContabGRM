...
Imports ClasesBLL
Public Class frmDinamicoOrdenesTrabajo
    ...
    Private Sub LlenarGrid()
        ...
        iPivotGrid.Fields("Bodega").Width = 160
        iPivotGrid.Fields("Descripción").Width = 270
    ...
    Private Sub bGrafico_Click(sender As Object, e As EventArgs) Handles bGrafico.Click
        With frmGraficosDinamicos
            ...
            .etTitulo.Text = "Gráfico Dinámico de Ordenes de Trabajo"
    ...
    Private Sub bExportar_Click(sender As Object, e As EventArgs) Handles bExportar.Click
        frmExportarImprimir.Mostrar(iPivotGrid, "Dinámico de Ordenes de Trabajo")
    End Sub

    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        ShowSplash("Generando Reporte...")
        Dim DT As DataTable = db_OrdenesTrabajo.Reporte(Desde.DateTime.Date, Hasta.DateTime.Date)
        iPivotGrid.DataSource = DT
        HideSplash()
    End Sub
