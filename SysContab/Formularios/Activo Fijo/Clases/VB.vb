...
Namespace VB.SysContab
    ...
    Public Class Activo_FijosDetails
        ...
        Public Valor_Libros As Double
        Public Valor_Rescate As Double
        Public Valor_Depreciado As Double
        Public Grupo_Depreciacion As String
        Public Cuenta_Activo As String
        ...
        Public Caract1, Caract2 As String
        Public MesesDepreciado As Integer
    End Class
    ...
    Public Class Articulos_AFijoDB
        ...
        Public Shared Function GetActivosContabilizar(ByVal Estado As String) As DataTable
            ...
            DBCommand = New SqlDataAdapter("_AF_GetActivosContabilizar", DBConn)

            DBCommand.SelectCommand.CommandType = CommandType.StoredProcedure

            Dim pEstado As New SqlParameter("@af_contabilizado", SqlDbType.NVarChar)
        ...
        Public Shared Function ArticulosConsulta(ByVal Codigo As String, ByVal Descripcion As String,
            ...
            Return dsFicha
        End Function
        Public Shared Function ArticulosConsultaLetra(ByVal Letra As String, ByVal Codigo As String,
                ByVal Descripcion As String, ByVal Linea As String, ByVal Proveedor As String,
        ...
        Public Shared Function GetListBuscar(ByVal Filtro As String, ByVal Tipo As String) As DataSet
            ...
            DBCommand = New SqlDataAdapter("SELECT ARTICULOS.CODIGO_ARTICULO, ARTICULOS.NOMBRE AS NOMBRE, ARTICULOS.PRECIO_VENTA_CORDOBAS AS PRECIO, ARTICULOS.COSTO AS COSTO, ARTICULOS.EXISTENCIAS AS CANTIDAD, PROVEEDORES.NOMBRE AS PROVEEDOR " &
                                           "FROM ARTICULOS_Afijo as Articulos INNER JOIN PROVEEDORES " &
                                           "ON ARTICULOS.PROVEEDOR = PROVEEDORES.CODIGO INNER JOIN EMPRESAS " &
                                           "ON EMPRESAS.CODIGO = ARTICULOS.EMPRESA " &
                                           "AND EMPRESAS.CODIGO = PROVEEDORES.EMPRESA " &
        ...
        Public Shared Sub AddItem(ByVal Codigo As String, ByVal Nombre As String, ByVal Proveedor As String,
                                ByVal Linea As String, ByVal Grupo As String, ByVal SubGrupo As String, ByVal Modelo As String,
                                ...
                                ByVal DescuentoMaximo As String, ByVal Tasa_Cambio As String, ByVal Tipo As String,
        ...
        Public Shared Sub Update(ByVal Codigo As String, ByVal Nombre As String, ByVal Proveedor As String,
                                ByVal Linea As String, ByVal Grupo As String, ByVal SubGrupo As String, ByVal Modelo As String,
                                ByVal Unidad As String, ByVal Presentacion As String, ByVal Ubicacion As String, ByVal PVCordobas As String, ByVal PVDolar As String,
                                ByVal Costo As String, ByVal Margen As String, ByVal Existencias As String, ByVal StockMin As String, ByVal StockMax As String,
                                ByVal DescuentoA As String, ByVal DescuentoB As String, ByVal DescuentoC As String,
                                ByVal DescuentoMaximo As String, ByVal Tasa_Cambio As String, ByVal Exento As String,
        ...
        Public Shared Function OrdenesCompraXProveedor(ByVal Proveedor As String, ByVal Fecha As String,
                ByVal Estado As String, ByVal Tipo As String, ByVal Origen As String,
        ...
        Public Shared Sub AddFacturaLineas_OrdenCompra(ByVal Factura As String, ByVal Item As String, ByVal Cantidad As String,
        ...
        Public Shared Function FacturasCompraLista(ByVal Proveedor As String, ByVal Fecha As String,
            ByVal Fecha1 As String, ByVal Mes As String, ByVal Estado As String,
            ByVal Tipo As String, ByVal TipoFactura As String, ByVal Origen As String,
            ByVal Destino As String) As DataSet
        ...
        End Sub
        Public Shared Sub AddFacturaLineas_FacturaCompra(ByVal Factura As String, ByVal Item As String, ByVal Cantidad As String,
    ...
    Public Class Activo_Fijo_BajaDB
        Public Shared Sub AddItem(ByVal Codigo As String, ByVal Fecha_Baja As Date, ByVal Empleado As String, _
            ...
            End Try
        End Sub
        Public Shared Sub UpdateItem(ByVal Codigo As String, ByVal Fecha_Baja As Date, ByVal Empleado As String, _
            ByVal Motivo As String, ByVal Fecha_Perdida As String, ByVal Documentos As String)
            ...
            End Try
        End Sub
        Public Shared Sub DeleteItem(ByVal Codigo As String)
    ...
    Public Class Activo_FijosDB
        ...
        Public Shared Function GetCodigo() As String
            ...
            Return ObtieneDatos("sp_GetCodigoActivoFijo", EmpresaActual).Rows.Item(0)("Codigo").ToString()

        End Function

        Public Shared Function GetFacturaDetalle_AfijoGenerado(ByVal Factura As String, ByVal Proveedor As Integer) As Boolean
            ...
            ' Se define el tipo de comando
            DBCommand = New SqlDataAdapter("_GetFacturaDetalle_AfijoGenerado", DBConn)
            DBCommand.SelectCommand.CommandType = CommandType.StoredProcedure

            Dim pIdent1 As New SqlParameter("@Factura", SqlDbType.NVarChar)
            Dim pIdent2 As New SqlParameter("@Proveedor", SqlDbType.Int)
            Dim pIdent3 As New SqlParameter("@Generado", SqlDbType.Bit)
            Dim pIdent12 As New SqlParameter("@Empresa", SqlDbType.Int)

            pIdent1.Value = Factura
            pIdent2.Value = Proveedor
        ...
        Public Shared Sub _AFijo_Generado(ByVal Factura As String, ByVal Proveedor As Integer, ByVal Valor As Boolean)
            ...
            ' Se define el tipo de comando
            DBCommand = New SqlDataAdapter("_AFijo_Generado", DBConn)
            DBCommand.SelectCommand.CommandType = CommandType.StoredProcedure

            Dim pIdent1 As New SqlParameter("@Factura", SqlDbType.NVarChar)
            Dim pIdent2 As New SqlParameter("@Proveedor", SqlDbType.Int)
            Dim pIdent3 As New SqlParameter("@Valor", SqlDbType.Bit)
            Dim pIdent12 As New SqlParameter("@Empresa", SqlDbType.Int)
        ...
        Public Shared Sub ActualizarActivoConsecutivo(ByVal Codigo As Integer)
            ...
            ' Se define el tipo de comando
            DBCommand = New SqlDataAdapter("_ActivoFijoCodigo_Actualizar", DBConnFacturas)
            DBCommand.SelectCommand.CommandType = CommandType.StoredProcedure
        ...
        Public Shared Function GetActivoConsecutivo() As Integer
            ...
            ' Se define el tipo de comando
            DBCommand = New SqlDataAdapter("_GetActivoFijoCodigo", DBConn)
            DBCommand.SelectCommand.CommandType = CommandType.StoredProcedure

            Dim pIdent1 As New SqlParameter("@Codigo", SqlDbType.Int)
            ...
            Try
                ...
                DBCommand.SelectCommand.ExecuteNonQuery()
                DBConn.Close()
                Return pIdent1.Value
            Catch ex As Exception
                MsgBox(ex.Message)
                Return -1
            End Try
        End Function
        Public Shared Function GeneradorReportes(ByVal Empleado As String, ByVal Departamento As String,
                                                 ByVal Cargo As String, ByVal Estado As String,
                                                 ByVal Situacion As String, ByVal Orden As String,
                                                 Optional ByVal dFrom As String = "",
                                                 Optional ByVal dTo As String = "") As DataSet
            Dim DBConn As SqlConnection
            Dim DBCommand As SqlDataAdapter
            Dim dsFicha As New DataSet
            ...
            Dim pdtFrom As New SqlParameter("@From", SqlDbType.NVarChar)
            Dim pdtTo As New SqlParameter("@To", SqlDbType.NVarChar)
            ...
            pdtFrom.Value = dFrom : pdtTo.Value = dTo
            ...
            DBCommand.SelectCommand.Parameters.Add(pdtFrom) : DBCommand.SelectCommand.Parameters.Add(pdtTo)
            Try
        ...
        'Public Shared Function GetListReporte(ByVal Empleado As String) As DataSet
        '    Dim DBConn As SqlConnection
        '    Dim DBCommand As SqlDataAdapter
        '    Dim dsFicha As New DataSet
        ...
        Public Shared Function GetDetails(ByVal Codigo As String) As Activo_FijosDetails
            ...
            If dsActivo_Fijos.Tables("Activo_Fijos").Rows.Count = 1 Then
                ...
                Details.Valor_Libros = dsActivo_Fijos.Tables("Activo_Fijos").Rows(0).Item("valor_libros")
                Details.Valor_Depreciado = dsActivo_Fijos.Tables("Activo_Fijos").Rows(0).Item("Depreciado")
                Details.Grupo_Depreciacion = dsActivo_Fijos.Tables("Activo_Fijos").Rows(0).Item("GRUPO_DEPRECIACION").ToString
                Details.Cuenta_Activo = dsActivo_Fijos.Tables("Activo_Fijos").Rows(0).Item("cta_activo").ToString
                Details.Cuenta_Inventario = dsActivo_Fijos.Tables("Activo_Fijos").Rows(0).Item("cta_inventario").ToString
                ...
                Details.Situacion = dsActivo_Fijos.Tables("Activo_Fijos").Rows(0).Item("Situacion")
                ...
                Details.MesesDepreciado = dsActivo_Fijos.Tables("Activo_Fijos").Rows(0).Item("MesesDepreciado")
                If IsDBNull(dsActivo_Fijos.Tables("Activo_Fijos").Rows(0)("fecha_factura")) Then
                    Details.Fecha_Factura = dsActivo_Fijos.Tables("Activo_fijos").Rows(0)("fecha_entrada")
                ElseIf dsActivo_Fijos.Tables("Activo_fijos").Rows(0)("fecha_factura") < Date.MinValue Then
                    Details.Fecha_Factura = dsActivo_Fijos.Tables("Activo_fijos").Rows(0)("fecha_entrada")
                Else
                    Details.Fecha_Factura = dsActivo_Fijos.Tables("Activo_fijos").Rows(0)("fecha_factura")
                End If
                Details.Valor_Rescate = dsActivo_Fijos.Tables("Activo_Fijos").Rows(0)("valor_rescate")
                ...
                Else 'Details.Tipo = "A" Or Details.Tipo = "M" Or Details.Tipo = "S" Then 'Equipo o Mobiliario
                    Details.PropiedadDetail = Nothing
                    Details.VehiculoDetail = Nothing
                    ...
                    Details.ArticuloDetail.Serie = dsActivo_Fijos.Tables("Activo_Fijos").Rows(0).Item("Serie").ToString
                    Details.ArticuloDetail.Modelo = dsActivo_Fijos.Tables("Activo_Fijos").Rows(0).Item("ModeloA").ToString
                End If
                Details.Caract1 = dsActivo_Fijos.Tables("Activo_Fijos").Rows(0).Item("Descrip1").ToString
                Details.Caract2 = dsActivo_Fijos.Tables("Activo_Fijos").Rows(0).Item("Descrip2").ToString

                Dim dt As New DataTable

                dt = RubrosGastosDB.Asignacion_Listar(Codigo, "1")

                If Not dt Is Nothing Then
                    If dt.Rows.Count > 0 Then
                        Details.Asignado = True
                        Details.FechaAsignacion = dt.Compute("Max(fechaefectiva)", "")
                    Else
                        Details.Asignado = False
                        Details.FechaAsignacion = Nothing
                    End If
                End If
            End If
        ...
        Public Shared Function GetList(ByVal Filtro As String, ByVal Mes As String, ByVal Mes2 As String) As DataSet
            Dim DBConn As SqlConnection
            Dim DBCommand As SqlDataAdapter
            Dim dsFicha As New DataSet
            'Dim cd As String
            ...
            DBCommand = New SqlDataAdapter("sp_sel_ACTIVO_FIJOS", DBConn)
            DBCommand.SelectCommand.CommandType = CommandType.StoredProcedure

            Dim pIdent As New SqlParameter("@Empresa", SqlDbType.Int)
            Dim pident1 As New SqlParameter("@Filtro", SqlDbType.NVarChar)
            Dim pident2 As New SqlParameter("@Mes", SqlDbType.NVarChar)
            Dim pident3 As New SqlParameter("@Mes2", SqlDbType.NVarChar)
            ...
            End Try
        End Function
        'Public Shared Function GetList_Fecha(ByVal Fecha As String) As DataTable
        '    Dim DBConn As SqlConnection
        '    Dim DBCommand As SqlDataAdapter
        '    Dim dsFicha As New DataSet
        ...
        '    DBCommand = New SqlDataAdapter("_GetListActivos_Fecha", DBConn)
        '    DBCommand.SelectCommand.CommandType = CommandType.StoredProcedure

        '    Dim pIdent As New SqlParameter("@Empresa", SqlDbType.Int)
        '    Dim pident1 As New SqlParameter("@Fecha", SqlDbType.SmallDateTime)
        ...
        Public Shared Function GetListAsignados(ByVal Empleado As String, ByVal CCosto As Integer) As DataTable
            Dim DBConn As SqlConnection
            Dim DBCommand As SqlDataAdapter
            Dim dsFicha As New DataSet
            'Dim cd As String
            ...
            DBCommand = New SqlDataAdapter("_GetListActivos_Asignados", DBConn)
            DBCommand.SelectCommand.CommandType = CommandType.StoredProcedure
            ...
            Dim pIdent2 As New SqlParameter("@CentroCosto", SqlDbType.Int)
            pIdent2.Value = CCosto
            DBCommand.SelectCommand.Parameters.Add(pIdent2)
        ...
        'Public Shared Function GetListActivoEmpleado(ByVal Codigo As String) As DataSet
        '    Dim DBConn As SqlConnection
        '    Dim DBCommand As SqlDataAdapter
        '    Dim dsFicha As New DataSet
        '    'Dim cd As String
        ...
        'End Function
        Public Shared Function GetListUMCD() As String
            Dim DBConn As SqlConnection
            Dim DBCommand As SqlDataAdapter
            'Dim cd As String
            Dim dsficha As New DataSet
            ...
            DBCommand = New SqlDataAdapter("_GetListEmpresa_UMCD", DBConn)
            DBCommand.SelectCommand.CommandType = CommandType.StoredProcedure
            ...
            Try
                ...
                If dsficha.Tables(0).Rows.Count = 1 Then
                    Return dsficha.Tables(0).Rows(0)("emp_UMCD")
                Else
                    Return Now.Date.Year.ToString & Now.Date.Month.ToString.PadLeft(2, "0")
                End If
                DBConn.Close()
            Catch ex As Exception
                MsgBox(ex.Message)
        ...
        Public Shared Function Delete2(ByVal Codigo As String) As String
            Dim Retval As String
            Try

                If GuardaDatos("_ActivoFijoDelete '" & Codigo & "', " & EmpresaActual) Then
                    Retval = "OK"
                Else
                    Retval = "ERROR"
                End If

                'Dim com As New SqlCommand("_ActivoFijoDelete", DBConnFacturas)
                ...
                'com.Parameters.Add(pIdent)
                'com.Parameters.Add(pIdent2)
        ...
        '    DBCommand = New SqlDataAdapter("_ActivoFijoDelete", DBConnFacturas)
        '    DBCommand.SelectCommand.CommandType = CommandType.StoredProcedure
        ...
        'End Sub
        Public Shared Function GetList_Meses(ByVal Filtro As String) As DataSet
            ...
            Dim pIdent1 As New SqlParameter("@Empresa", SqlDbType.Int)
            Dim pIdent2 As New SqlParameter("@Contabilizado", SqlDbType.NVarChar)
        ...
        End Function
        Public Shared Function Calc_Depreciacion(ByVal Fecha As Date, ByVal Mes As String) As Boolean
            ...
            Dim pIdent5 As New SqlParameter("@UltimodeMes", SqlDbType.SmallDateTime)
            Dim pIdent3 As New SqlParameter("@Estado", SqlDbType.Int)
            Dim pIdent4 As New SqlParameter("@Mes", SqlDbType.NVarChar)
            pIdent3.Direction = ParameterDirection.Output
            ...
            pIdent3.Value = 0
            pIdent4.Value = Mes
            pIdent5.Value = New Date(Microsoft.VisualBasic.Left(Mes, 4), Microsoft.VisualBasic.Right(Mes, 2), Date.DaysInMonth(Microsoft.VisualBasic.Left(Mes, 4), Microsoft.VisualBasic.Right(Mes, 2)))
            ...
            End Try
        End Function
        Public Shared Function Calc_Depreciacion_pendiente(ByVal Fecha As Date, ByVal Mes As String) As DataTable
            ...
            ' Se define el tipo de comando
            DBCommand = New SqlDataAdapter("_AF_DepreciacionPendiente", DBConn)
            DBCommand.SelectCommand.CommandType = CommandType.StoredProcedure
            ...
            Try
                DBCommand.Fill(dsficha, "Pendientes")
            Catch ex As Exception
                MsgBox(ex.Message)
            End Try
            DBConn.Close()
        ...
        Public Shared Sub AddItem_Articulo(ByVal Codigo As String, ByVal Descripcion As String,
          ByVal Precio As Double, ByVal ValorLibros As Double, ByVal Grupo_Depreciacion As String,
          ByVal Cuenta_Activo As String, ByVal Cuenta_Inventario As String, ByVal Cuenta_Gastos As String, ByVal Cuenta_Depreciacion As String,
          ByVal Fecha_Entrada As Date,
          ByVal Codigo_barra As String, ByVal Unidad As String,
          ByVal Estado As String, ByVal Situacion As String, ByVal Tipo As String,
          ByVal Factura As String, ByVal Proveedor As String, ByVal lComentarios As String,
          ByVal Serie As String, ByVal Modelo As String, ByVal Fecha_Factura As Date,
          ByVal Valor_Rescate As Double, ByVal Inicial As Boolean)
            ...
            ' Se define el tipo de comando
            DBCommand = New SqlDataAdapter("_ActivoFijoAdd_Articulo", DBConnFacturas)
            DBCommand.SelectCommand.CommandType = CommandType.StoredProcedure

            Dim pIdent1 As New SqlParameter("@Codigo", SqlDbType.NVarChar)
            Dim pIdent2 As New SqlParameter("@Descripcion", SqlDbType.NVarChar)
            Dim pIdent3 As New SqlParameter("@Fecha_Entrada", SqlDbType.SmallDateTime)
            Dim pIdent4 As New SqlParameter("@Precio", SqlDbType.Float)
            Dim pIdent18 As New SqlParameter("@Valor_Libros", SqlDbType.Float)
            ...
            Dim PModelo As New SqlParameter("@Modelo", SqlDbType.NVarChar)

            Dim FFactura As New SqlParameter("@Fecha_Factura", SqlDbType.SmallDateTime)
            FFactura.Value = Fecha_Factura
            DBCommand.SelectCommand.Parameters.Add(FFactura)

            Dim VRescate As New SqlParameter("@Valor_rescate", SqlDbType.Float)
            VRescate.Value = Valor_Rescate
            DBCommand.SelectCommand.Parameters.Add(VRescate)

            Dim VCuentaActivo As New SqlParameter("@CuentaActivo", SqlDbType.NVarChar)
            VCuentaActivo.Value = Cuenta_Activo
            DBCommand.SelectCommand.Parameters.Add(VCuentaActivo)

            Dim VCuentaInventario As New SqlParameter("@CuentaInventario", SqlDbType.NVarChar)
            VCuentaInventario.Value = Cuenta_Inventario
            DBCommand.SelectCommand.Parameters.Add(VCuentaInventario)

            Dim vInicial As New SqlParameter("@Inicial", SqlDbType.Float)
            vInicial.Value = Inicial
            DBCommand.SelectCommand.Parameters.Add(vInicial)
            ...
            DBCommand.SelectCommand.Parameters.Add(PSerie)
            DBCommand.SelectCommand.Parameters.Add(PModelo)
        ...
        Public Shared Sub AddItem_Propiedad(ByVal Codigo As String, ByVal Descripcion As String,
          ByVal Precio As Double, ByVal ValorLibros As Double, ByVal Grupo_Depreciacion As String,
          ByVal Cuenta_Activo As String, ByVal Cuenta_Inventario As String, ByVal Cuenta_Gastos As String,
          ByVal Cuenta_Depreciacion As String, ByVal Fecha_Entrada As Date,
          ByVal Registro_Catastral As String, ByVal Escritura As String, ByVal Fecha_escritura As String,
          ByVal lRegistro As String, ByVal Tomo As String, ByVal Folio As String,
          ByVal Estado As String, ByVal Situacion As String, ByVal Tipo As String, ByVal lComentarios As String,
          ByVal Fecha_factura As Date, ByVal Valor_Rescate As Double, ByVal Inicial As Boolean)
            ...
            ' Se define el tipo de comando
            DBCommand = New SqlDataAdapter("_ActivoFijoAdd_Propiedad", DBConnFacturas)
            DBCommand.SelectCommand.CommandType = CommandType.StoredProcedure
            ...
            Dim pIdent3 As New SqlParameter("@Fecha_Entrada", SqlDbType.SmallDateTime)
            Dim pIdent4 As New SqlParameter("@Precio", SqlDbType.Float)
            Dim pIdent20 As New SqlParameter("@Valor_Libros", SqlDbType.Float)
            Dim pIdent5 As New SqlParameter("@Grupo_Depreciacion", SqlDbType.NVarChar)
            Dim pIdent6 As New SqlParameter("@Codigo_Empleado", SqlDbType.NVarChar)
            Dim pIdent7 As New SqlParameter("@Cuenta_Gastos", SqlDbType.NVarChar)
            Dim pIdent8 As New SqlParameter("@Cuenta_Depreciacion", SqlDbType.NVarChar)
        ...
        Public Shared Sub AddItem_Vehiculo(ByVal Codigo As String, ByVal Descripcion As String,
          ByVal Precio As Double, ByVal ValorLibros As Double, ByVal Grupo_Depreciacion As String,
          ByVal Cuenta_Activo As String, ByVal Cuenta_Inventario As String, ByVal Cuenta_Gastos As String, ByVal Cuenta_Depreciacion As String,
          ByVal Fecha_Entrada As Date,
          ByVal Estado As String, ByVal Situacion As String, ByVal Tipo As String, ByVal Motor As String,
          ByVal Chasis As String, ByVal Marca As String, ByVal Modelo As String, ByVal TipoAuto As String,
          ByVal Color As String, ByVal Placa As String, ByVal Año As String, ByVal Factura As String,
          ByVal Proveedor As String, ByVal lComentarios As String, ByVal Fecha_Factura As Date,
          ByVal Valor_Rescate As Double, ByVal Inicial As Boolean)
            ...
            ' Se define el tipo de comando
            DBCommand = New SqlDataAdapter("_ActivoFijoAdd_Vehiculo", DBConnFacturas)
            DBCommand.SelectCommand.CommandType = CommandType.StoredProcedure
            ...
            Dim pIdent3 As New SqlParameter("@Fecha_Entrada", SqlDbType.SmallDateTime)
            Dim pIdent4 As New SqlParameter("@Precio", SqlDbType.Float)
            Dim pIdent24 As New SqlParameter("@Valor_Libros", SqlDbType.Float)
            Dim pIdent5 As New SqlParameter("@Grupo_Depreciacion", SqlDbType.NVarChar)
            Dim pIdent6 As New SqlParameter("@Codigo_Empleado", SqlDbType.NVarChar)
            Dim pIdent7 As New SqlParameter("@Cuenta_Gastos", SqlDbType.NVarChar)
            Dim pIdent8 As New SqlParameter("@Cuenta_Depreciacion", SqlDbType.NVarChar)
        ...
        Public Shared Sub AsignarActivo(ByVal Empleado As String, ByVal Codigo As String)
        ...
        Public Shared Sub TrasladarActivo(ByVal EmpleadoAnterior As String, ByVal EmpleadoNuevo As String, ByVal Codigo As String)
        ...
        Public Shared Sub UpdateItem_Articulo(ByVal Codigo As String, ByVal Descripcion As String,
          ByVal Precio As Double, ByVal Grupo_Depreciacion As String,
          ByVal Cuenta_Activo As String, ByVal Cuenta_Inventario As String, ByVal Cuenta_Gastos As String,
          ByVal Cuenta_Depreciacion As String, ByVal Fecha_Entrada As Date, ByVal Codigo_barra As String,
          ByVal Unidad As String, ByVal Estado As String, ByVal Situacion As String, ByVal Tipo As String,
          ByVal Factura As String, ByVal Proveedor As String, ByVal lComentarios As String,
          ByVal Serie As String, ByVal Modelo As String, ByVal Tipos As String, ByVal Fecha_factura As Date,
        ByVal Valor_Rescate As Double)
            ...
            Dim pIdent16 As New SqlParameter("@Proveedor", SqlDbType.NVarChar)
            Dim pIdent17 As New SqlParameter("@Comentarios", SqlDbType.NVarChar)
            Dim pIdent18 As New SqlParameter("@Serie", SqlDbType.NVarChar)
            Dim pIdent19 As New SqlParameter("@Modelo", SqlDbType.NVarChar)
            Dim pIdent20 As New SqlParameter("@Tipo", SqlDbType.NVarChar)
            ...
            pIdent16.Value = Proveedor
            pIdent17.Value = lComentarios
            pIdent18.Value = Serie
            pIdent19.Value = Modelo
            pIdent20.Value = Tipos
        ...
        Public Shared Sub UpdateItem_Propiedad(ByVal Codigo As String, ByVal Descripcion As String,
          ByVal Precio As Double, ByVal Grupo_Depreciacion As String,
          ByVal Cuenta_Activo As String, ByVal Cuenta_Inventario As String,
          ByVal Cuenta_Gastos As String, ByVal Cuenta_Depreciacion As String, ByVal Fecha_Entrada As Date,
          ByVal Registro_Catastral As String, ByVal Escritura As String, ByVal Fecha_escritura As String,
          ByVal lRegistro As String, ByVal Tomo As String, ByVal Folio As String,
          ByVal Estado As String, ByVal Situacion As String, ByVal Tipo As String,
          ByVal lComentarios As String, ByVal Proveedor As String, ByVal Tipos As String,
          ByVal Fecha_Factura As Date, ByVal Valor_Rescate As Double)
            ...
            Dim pIdent18 As New SqlParameter("@Folio", SqlDbType.NVarChar)
            Dim pIdent19 As New SqlParameter("@Comentarios", SqlDbType.NVarChar)
            Dim pIdent20 As New SqlParameter("@Proveedor", SqlDbType.NVarChar)
            'Dim pIdent21 As New SqlParameter("@Tipo", SqlDbType.NVarChar)
            ...
            pIdent18.Value = Folio
            pIdent19.Value = lComentarios
            pIdent20.Value = Proveedor
            'pIdent21.Value = Tipos
        ...
        Public Shared Sub UpdateItem_Vehiculo(ByVal Codigo As String, ByVal Descripcion As String,
          ByVal Precio As String, ByVal Grupo_Depreciacion As String,
          ByVal Cuenta_Activo As String, ByVal Cuenta_Inventario As String,
          ByVal Cuenta_Gastos As String, ByVal Cuenta_Depreciacion As String, ByVal Fecha_Entrada As Date,
          ByVal Estado As String, ByVal Situacion As String, ByVal Tipo As String, ByVal Motor As String,
          ByVal Chasis As String, ByVal Marca As String, ByVal Modelo As String, ByVal TipoAuto As String,
          ByVal Color As String, ByVal Placa As String, ByVal Año As String, ByVal Factura As String,
          ByVal Proveedor As String, ByVal lComentarios As String, ByVal Tipos As String,
        ByVal Fecha_Factura As Date, ByVal Valor_Rescate As Double)
            ...
            Dim pIdent22 As New SqlParameter("@Proveedor", SqlDbType.NVarChar)
            Dim pIdent23 As New SqlParameter("@Comentarios", SqlDbType.NVarChar)
            'Dim pIdent24 As New SqlParameter("@Tipo", SqlDbType.NVarChar)
        ...
        Public Shared Function Depreciacion_Imprimir(ByVal Mes As String, ByVal Moneda As String) As DataSet
            Dim DBConn As SqlConnection
            Dim DBCommand As SqlDataAdapter
            Dim dsFicha As New DataSet
        ...
        Public Shared Function GetDepreciacion(ByVal Codigo As String) As DataTable
            Dim v As New Connect(VB.SysContab.Rutinas.AbrirConexion)
            v.AddParameter("Empresa", SqlDbType.Int, 5, ParameterDirection.Input, EmpresaActual)
            v.AddParameter("Activo", SqlDbType.NVarChar, 16, ParameterDirection.Input, Codigo)
            Try
                Return v.EjecutarComando("_AF_GetDetalleDepreciacion")
                v = Nothing
            Catch ex As Exception
                MsgBox(ex.Message)
            End Try
        ...
        Public Shared Function GetMovimientos(ByVal Codigo As String, ByVal Filtro As String) As DataTable
            Dim v As New Connect(VB.SysContab.Rutinas.AbrirConexion)
            v.AddParameter("Empresa", SqlDbType.Int, 5, ParameterDirection.Input, EmpresaActual)
            v.AddParameter("Activo", SqlDbType.NVarChar, 16, ParameterDirection.Input, Codigo)
            v.AddParameter("Filtro", SqlDbType.NVarChar, 1, ParameterDirection.Input, Filtro)
            Try
                Return v.EjecutarComando("_AF_GetDetalleMovimientos")
                v = Nothing
            Catch ex As Exception
                MsgBox(ex.Message)
            End Try
        ...
        Public Shared Function GetListTransaccion() As DataTable
            Dim v As New Connect(VB.SysContab.Rutinas.AbrirConexion)
            Try
                Return v.EjecutarComando("_AF_GetListTransaccion")
                v = Nothing
            Catch ex As Exception
                MsgBox(ex.Message)
            End Try
        ...
        Public Shared Sub TranValor_Add(ByVal Codigo As String, ByVal TipoTransaccion As Integer,
            ByVal Fecha As Date, ByVal Valor As Double, ByVal Concepto As String)
            Dim v As New Connect(VB.SysContab.Rutinas.AbrirConexion)
            v.AddParameter("Empresa", SqlDbType.Int, 5, ParameterDirection.Input, EmpresaActual)
            v.AddParameter("Activo", SqlDbType.NVarChar, 16, ParameterDirection.Input, Codigo)
            v.AddParameter("CodigoTransaccion", SqlDbType.Int, 5, ParameterDirection.Input, TipoTransaccion)
            v.AddParameter("Fecha", SqlDbType.SmallDateTime, 8, ParameterDirection.Input, Fecha)
            v.AddParameter("Valor", SqlDbType.Money, 8, ParameterDirection.Input, Valor)
            v.AddParameter("Concepto", SqlDbType.Text, 4000, ParameterDirection.Input, Concepto)

            Try
                v.EjecutarComando("_AF_TranValor_Add")
                v = Nothing
            Catch ex As Exception
                MsgBox(ex.Message)
            End Try
        ...
        Public Shared Sub TranValor_Anular(ByVal Codigo As String)
            Dim v As New Connect(VB.SysContab.Rutinas.AbrirConexion)
            v.AddParameter("Consecutivo", SqlDbType.Int, 5, ParameterDirection.Input, Codigo)
            Try
                v.EjecutarComando("_AF_AnularMovimiento")
                v = Nothing
            Catch ex As Exception
                MsgBox(ex.Message)
            End Try
        ...
        Public Shared Sub TranValor_Contabilizar(ByVal Codigo As String)
            Dim cmd As New SqlCommand("_AF_ContabilizarMovimiento", DBConnFacturas)
            cmd.CommandType = CommandType.StoredProcedure

            Dim p1 As New SqlParameter("@Consecutivo", SqlDbType.Int)
            p1.Value = Codigo
        ...
        Public Shared Sub Inclusion_Contabilizar(ByVal Codigo As String, ByVal Contabilizado As Boolean)
            Dim cmd As New SqlCommand("_AF_ContabilizarInclusion", DBConnFacturas)
            cmd.CommandType = CommandType.StoredProcedure

            Dim p1 As New SqlParameter("@Codigo", SqlDbType.NVarChar)
            Dim p2 As New SqlParameter("@Empresa", SqlDbType.Int)
            Dim p3 As New SqlParameter("@Contabilizado", SqlDbType.Bit)

            p1.Value = Codigo
            p2.Value = EmpresaActual
            p3.Value = Contabilizado
        ...
        Public Shared Sub AF_UpdateSituacion(ByVal Codigo As String, ByVal Situacion As String)
            Dim cmd As New SqlCommand("AF_UpdateSituacion", DBConnFacturas)
            cmd.CommandType = CommandType.StoredProcedure

            Dim p1 As New SqlParameter("@Empresa", SqlDbType.Int)
            p1.Value = EmpresaActual
            cmd.Parameters.Add(p1)

            Dim p2 As New SqlParameter("@Activo", SqlDbType.NVarChar)
            p2.Value = Codigo
            cmd.Parameters.Add(p2)

            Dim p3 As New SqlParameter("@Situacion", SqlDbType.NVarChar)
            p3.Value = Situacion
            cmd.Parameters.Add(p3)
        ...
        Public Shared Sub AF_ValorLibrosUpdate(ByVal Codigo As String, Optional ByVal Valor As Decimal = 0)

            Dim cmd As New SqlCommand("UPDATE ACTIVO_FIJOS SET Valor_Libros = valor_libros -  " & Valor.ToString & " WHERE CODIGO_ACTIVO = '" & Codigo & "' and empresa = " & EmpresaActual.ToString, DBConnFacturas)
            cmd.CommandType = CommandType.Text
        ...
        Public Shared Function GetMovimientoDetalle(ByVal Codigo As Integer) As DataTable
            Dim v As New Connect(VB.SysContab.Rutinas.AbrirConexion)
            v.AddParameter("Consecutivo", SqlDbType.Int, 5, ParameterDirection.Input, Codigo)
            Try
                Return v.EjecutarComando("_AF_GetMovimientoDetalle", "Detalle")
                v = Nothing
            Catch ex As Exception
                MsgBox(ex.Message)
            End Try
        ...
        Public Shared Function ContarMovimientosxTipo(ByVal Codigo As Integer) As DataTable
            Dim v As New Connect(VB.SysContab.Rutinas.AbrirConexion)
            v.AddParameter("Empresa", SqlDbType.Int, 5, ParameterDirection.Input, EmpresaActual)
            v.AddParameter("Activo", SqlDbType.NVarChar, 50, ParameterDirection.Input, Codigo)
            Try
                Return v.EjecutarComando("_AF_ContarMovimientosxTipo", "Detalle")
                v = Nothing
            Catch ex As Exception
                MsgBox(ex.Message)
            End Try
