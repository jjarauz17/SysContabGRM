...
Public Class frmOrdenesEntregaPendientes
    ...
    Public Sub Cargar()
        iGrid.DataSource = db_OrdenesEntrega.ListarPendiente()
    End Sub
    ...
    Sub Imprimir(IdOrden As Integer)
        ...
        rpt.DataSource = ObtieneDatos("sp_sel_OrdenesEntrega_Imprimir", IdOrden, EmpresaActual)
    ...
    Private Sub frmOrdenesEntregaPendientes_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.F5 Then
            ShowSplash("Buscando Ordenes Pendientes...")
            Cargar()
            HideSplash()
        End If
    End Sub
