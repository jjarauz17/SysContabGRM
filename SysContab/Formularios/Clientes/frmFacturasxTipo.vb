Public Class frmFacturasxTipo
    Inherits DevExpress.XtraEditors.XtraForm

    Private Shared ChildInstance As frmFacturasxTipo = Nothing

    Public Shared Function Instance() As frmFacturasxTipo
        If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
            ChildInstance = New frmFacturasxTipo()
        End If
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmFacturasxTipo))
...
#End Region
    ...
    Private Sub frmFacturasxTipo_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        etDescripcion.Text = "Facturas del Cliente:  " & DetallesCliente.Nombre

        etDescripcion.BackColor = Color.FromArgb(102, 153, 153)
        etDescripcion.ForeColor = Color.White

        ds = Clientes.FacturasXTipo(RegistroCliente, TipoFacturaCliente, Fecha1, Fecha2)
        ...
        'dgFacturasClientes.CaptionText = "          Información de Facturas de Clientes"
