...
Namespace DataGridTextBoxCombo
    Public Class frmDevolucionClienteBodega
        Inherits DevExpress.XtraEditors.XtraForm

        Private Shared ChildInstance As frmDevolucionClienteBodega = Nothing

        Public Shared Function Instance() As frmDevolucionClienteBodega
            If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
                ChildInstance = New frmDevolucionClienteBodega()
            End If
...
#Region " Código generado por el Diseñador de Windows Forms "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            'cmbbodega
            '
            Me.cmbbodega.Location = New System.Drawing.Point(80, 17)
            ...
            Me.cmbbodega.Size = New System.Drawing.Size(304, 20)
            Me.cmbbodega.TabIndex = 158
            '
            'cbTodos
            '
            ...
            Me.etSaldoT.Location = New System.Drawing.Point(16, 461)
            Me.etSaldoT.Name = "etSaldoT"
            Me.etSaldoT.Size = New System.Drawing.Size(56, 19)
            ...
            Me.etSaldo.Location = New System.Drawing.Point(80, 461)
            Me.etSaldo.Name = "etSaldo"
            Me.etSaldo.Size = New System.Drawing.Size(96, 19)
            ...
            Me.etSubTotal.Location = New System.Drawing.Point(280, 461)
            Me.etSubTotal.Name = "etSubTotal"
            Me.etSubTotal.Size = New System.Drawing.Size(112, 19)
            ...
            Me.etSubTotalT.Location = New System.Drawing.Point(192, 461)
            Me.etSubTotalT.Name = "etSubTotalT"
            Me.etSubTotalT.Size = New System.Drawing.Size(80, 19)
            ...
            Me.etIva.Location = New System.Drawing.Point(504, 461)
            Me.etIva.Name = "etIva"
            Me.etIva.Size = New System.Drawing.Size(112, 19)
            ...
            Me.etIvaT.Location = New System.Drawing.Point(400, 461)
            Me.etIvaT.Name = "etIvaT"
            Me.etIvaT.Size = New System.Drawing.Size(96, 19)
            ...
            Me.gbBotones.Size = New System.Drawing.Size(88, 406)
            ...
            Me.etTotal.Location = New System.Drawing.Point(688, 452)
            Me.etTotal.Name = "etTotal"
            Me.etTotal.Size = New System.Drawing.Size(168, 28)
            ...
            Me.etTotalT.Location = New System.Drawing.Point(624, 461)
            Me.etTotalT.Name = "etTotalT"
            Me.etTotalT.Size = New System.Drawing.Size(56, 19)
            ...
            Me.dgFacturacionCliente.Size = New System.Drawing.Size(896, 406)
            ...
            Me.Name = "frmDevolucionClienteBodega"
...
#End Region
        ...
        Private Sub frmDevolucionClienteBodega_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            'txtFactura.Text = Devolucion.DevolucionDetalle(Me.txtDevolucion.Text).Tables("Facturas_Ventas").Rows(0).Item("Factura")
            'txtFactura.ReadOnly = True

            ds = DevolucionBodega.DevolucionDetalleNew(Me.txtDevolucion.Text, Me.txtFactura.Text) 'Clientes.FacturaDetalleDevolucion(txtFactura.Text)
            ...
            Me.Text = "Entrada a Bodega por Devolución"
        ...
        Private Sub cmdAceptar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdAceptar.Click
            ...
            If IsNull(cmbbodega.EditValue, 0) = 0 Then
                MsgBox("Seleccione la bodega a darle la entrada")
                cmbbodega.Focus()
                Exit Sub
            End If
            ...
            Try
                ...
                i = 0
                VB.SysContab.BodegasDB.TransaccionBodega_Add(cmbbodega.EditValue, "D", txtDevolucion.Text, Me.dtpFecha.Value, 0)
                For i = 0 To tCust.Rows.Count - 1
                    If tCust.Rows(i)("Agregar") = True Then
                        ...
                        End If
                        VB.SysContab.BodegasDB.Bodega_Articulos_Add(cmbbodega.EditValue, tCust.Rows(i)("CodigoTemporal"), CDbl(tCust.Rows(i)("Cantidad")), CDbl(tCust.Rows(i)("Precio")), tCust.Rows(i)("Tipo"))
                        'Articulos.SumarExistencias(tCust.Rows(k)("CodigoTemporal"), CDbl(tCust.Rows(k)("Cantidad")), tCust.Rows(k)("Tipo"))
                        VB.SysContab.BodegasDB.TransaccionBodegaDetalle_Add(cmbbodega.EditValue, tCust.Rows(i)("CodigoTemporal"), "D", txtDevolucion.Text, "E", CDbl(tCust.Rows(i)("Cantidad")), CDbl(tCust.Rows(i)("Precio")), 0, tCust.Rows(i)("Tipo"))
                    End If
                Next
