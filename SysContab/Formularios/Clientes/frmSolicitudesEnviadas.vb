...
Public Class frmSolicitudesEnviadas
    ...
    Sub Cargar()
        iGrid.DataSource = db_SolicitudesVencimiento.ListarEnviadas(0, cbEstado.EditValue)
    End Sub
    ...
    Private Sub SimpleButton8_Click(sender As Object, e As EventArgs) Handles SimpleButton8.Click
        ...
        frmSolicitudesAdd.Dispose()
        frmSolicitudesAdd.MdiParent = Me.MdiParent
        frmSolicitudesAdd.Text = "Nueva Solicitud"
        frmSolicitudesAdd.IdSolicitud = iVista.GetFocusedRowCellValue("IdSolicitud")
        frmSolicitudesAdd.Show()
        frmSolicitudesAdd.WindowState = FormWindowState.Maximized
        HideSplash()
    End Sub
    ...
    Private Sub SimpleButton1_Click_1(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        ...
        frmSolicitudesAdd.MdiParent = Me.MdiParent
        frmSolicitudesAdd.Text = "Nueva Solicitud"
        frmSolicitudesAdd.IdSolicitud = 0
        frmSolicitudesAdd.Show()
        frmSolicitudesAdd.WindowState = FormWindowState.Maximized
    End Sub
    ...
    Private Sub bReenviar_Click(sender As Object, e As EventArgs) Handles bReenviar.Click
        If iVista.FocusedRowHandle < 0 Then
            XtraMsg("Seleccione un Registro!")
            Exit Sub
        End If
        ...
        db_SolicitudesVencimiento.EnviarSolicitud(
            iVista.GetFocusedRowCellValue("IdSolicitud"))
        HideSplash()
        XtraMsg("La Solicitud ha sido reenviado con exito!")
    End Sub
End Class