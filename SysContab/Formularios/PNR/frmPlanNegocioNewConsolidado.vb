...
Public Class frmPlanNegocioNewConsolidado
    ...
    Sub LlenarGrid()
        Dim DT As DataTable = db_PNR_PlanNegocio.ReporteVerConsolidado(cbPeriodo.EditValue)
        '
        ...
        iPivotGrid.Fields("Cliente").Width = 220
