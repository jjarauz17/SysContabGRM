...
Public Class frmPlanNegocioNewVer

    Dim IdPresupuesto As Integer = 0,
        db As New db_PNR_PlanNegocio
    ...
    Sub Mostrar(ID As Integer,
        ...
        txtNumero.Text = db_PNR_PlanNegocio.Detalles(IdPresupuesto).Codigo
    ...
    Sub LlenarGrid()
        ...
        Dim DT As DataTable = db_PNR_PlanNegocio.ReporteVer(IdPresupuesto)
        '
        ...
        iPivotGrid.Fields("Cantidad").Caption = "Proyección"
        ...
        iPivotGrid.Fields("Unidad").Area = DevExpress.XtraPivotGrid.PivotArea.RowArea
    ...
    Private Sub bGrafico_Click(sender As Object, e As EventArgs) Handles bGrafico.Click
        With frmGraficosDinamicos
            ...
            .etTitulo.Text = "Gráfico Dinámico de PNR"
