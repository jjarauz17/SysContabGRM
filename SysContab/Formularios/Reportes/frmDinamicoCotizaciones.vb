...
Public Class frmDinamicoCotizaciones
    ...
    Private Sub LlenarGrid()
        Dim DT As DataTable = VB.SysContab.ClientesDB.DinamicoCotizaciones(Desde.DateTime.Date.AddMonths(2).Date, Hasta.DateTime.Date, cbMoneda.EditValue)
    ...
    Private Sub bGrafico_Click(sender As Object, e As EventArgs) Handles bGrafico.Click
        With frmGraficosDinamicos
            ...
            .etTitulo.Text = "Gráfico Dinámico de Cotizaciones"
    ...
    Private Sub bExportar_Click(sender As Object, e As EventArgs) Handles bExportar.Click
        frmExportarImprimir.Mostrar(iPivotGrid, "Dinámico de Cotizaciones")
    End Sub
