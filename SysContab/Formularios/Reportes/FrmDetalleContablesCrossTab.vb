Public Class FrmDetalleContablesCrossTab
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GridColumn3.FieldName = "comp_id"
        Me.GridColumn3.Name = "GridColumn3"
        '
        'GridColumn10
        '
        Me.GridColumn10.Caption = "GridColumn10"
        Me.GridColumn10.FieldName = "Per_Id"
        ...
        Me.cmdexportar.Location = New System.Drawing.Point(880, 6)
        Me.cmdexportar.Name = "cmdexportar"
        Me.cmdexportar.Size = New System.Drawing.Size(112, 25)
        ...
        Me.Name = "FrmDetalleContablesCrossTab"
...
#End Region
        ...
        For Each i As Integer In MyVista.GetSelectedRows
            ...
            Else
                ...
                Ds = VB.SysContab.DistribucionDB.GetData(MyVista.GetRowCellValue(i, "comp_id"), _
                    MyVista.GetRowCellValue(i, "Per_Id"), MyVista.GetRowCellValue(i, "Comp_fecha"), Me.MonedaCambio)
    ...
    Private Sub rbComprobantes_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rbComprobantes.CheckedChanged
