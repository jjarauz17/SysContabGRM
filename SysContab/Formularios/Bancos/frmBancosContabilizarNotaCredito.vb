Public Class frmBancosContabilizarNotaCredito
    Inherits DevExpress.XtraEditors.XtraForm

    Private Shared ChildInstance As frmBancosContabilizarNotaCredito = Nothing
    ...
    Public Shared Function Instance() As frmBancosContabilizarNotaCredito
        If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
            ChildInstance = New frmBancosContabilizarNotaCredito()
        End If
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    Friend WithEvents etDevolucion As System.Windows.Forms.Label
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.etDevolucion = New System.Windows.Forms.Label
        ...
        Me.dgBancos.Size = New System.Drawing.Size(976, 207)
        ...
        'lblFactMonto
        '
        Me.lblFactMonto.Location = New System.Drawing.Point(912, 489)
        ...
        Me.dgCatalogoBancos.Location = New System.Drawing.Point(8, 214)
        ...
        Me.dgCatalogoBancos.Size = New System.Drawing.Size(976, 215)
        Me.dgCatalogoBancos.TabIndex = 141
        '
        'etCodigoProveedor
        '
        Me.etCodigoProveedor.Location = New System.Drawing.Point(824, 454)
        ...
        'etSubTotal
        '
        Me.etSubTotal.Location = New System.Drawing.Point(784, 489)
        ...
        'etDevolucion
        '
        Me.etDevolucion.Location = New System.Drawing.Point(344, 121)
        Me.etDevolucion.Name = "etDevolucion"
        Me.etDevolucion.Size = New System.Drawing.Size(100, 24)
        Me.etDevolucion.TabIndex = 146
        Me.etDevolucion.Visible = False
        '
        'frmBancosContabilizarNotaCredito
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 14)
        Me.ClientSize = New System.Drawing.Size(1016, 526)
        Me.Controls.Add(Me.etDevolucion)
        ...
        Me.Name = "frmBancosContabilizarNotaCredito"
...
#End Region
    ...
    Private Sub frmBancosContabilizarNotaCredito_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cmdModificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdModificar.Click
        ...
        Dim f As DataGridTextBox.frmComprobanteNotaCredito = DataGridTextBox.frmComprobanteNotaCredito.Instance
        ...
        f.txtDevolucion.Text = Me.etDevolucion.Text
