...
Namespace DataGridTextBoxCombo
    Public Class frmChequesInatec
        Inherits DevExpress.XtraEditors.XtraForm

        Private Shared ChildInstance As frmChequesInatec = Nothing

        Public Shared Function Instance() As frmChequesInatec
            If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
                ChildInstance = New frmChequesInatec()
            End If
...
#Region " Código generado por el Diseñador de Windows Forms "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.GroupBox1.Size = New System.Drawing.Size(1000, 158)
            ...
            Me.etMontoLetras.Location = New System.Drawing.Point(149, 69)
            ...
            Me.Label7.Location = New System.Drawing.Point(364, 506)
            ...
            Me.txtDocumento.Location = New System.Drawing.Point(500, 506)
            ...
            Me.cmdAceptar.Location = New System.Drawing.Point(12, 506)
            ...
            Me.cmdSalir.Location = New System.Drawing.Point(276, 506)
            ...
            Me.cmdRecalcular.Location = New System.Drawing.Point(188, 506)
            ...
            Me.cmdImprimir.Location = New System.Drawing.Point(100, 506)
...
#End Region
        ...
        Private Sub frmChequesInatec_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Private Function Guardar() As Boolean
            ...
            Try
                ...
                dsInatec = VB.SysContab.PeriodoNominaDB.InatecXMes(Me.Mes)

                For i = 0 To dsInatec.Tables("Tabla").Rows.Count - 1
                    Comprobantes.PagosFactura(dsInatec.Tables("Tabla").Rows(i).Item("Comp_No"), dsInatec.Tables("Tabla").Rows(i).Item("Per_ID"), dsInatec.Tables("Tabla").Rows(i).Item("Comp_Fecha"), dsInatec.Tables("Tabla").Rows(i).Item("Monto"), NoComprob, VB.SysContab.PeriodosDB.Activo(Me.dtpFecha.Value), dtpFecha.Value, 0, 0, "001")
                Next
        ...
        Private Sub frmChequesInatec_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
            Dim f As frmInatecPagar = f.Instance
            f.dgPlanillas.DataSource = VB.SysContab.PeriodoNominaDB.InatecPagar().Tables(0)
        End Sub
