...
Namespace DataGridTextBox
    Public Class frmComprobanteAlcaldiaImpuestos
        Inherits DevExpress.XtraEditors.XtraForm

        Private Shared ChildInstance As frmComprobanteAlcaldiaImpuestos = Nothing

        Public Shared Function Instance() As frmComprobanteAlcaldiaImpuestos
            If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
                ChildInstance = New frmComprobanteAlcaldiaImpuestos()
            End If
...
#End Region
        ...
        Private Sub frmComprobanteAlcaldiaImpuestos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
