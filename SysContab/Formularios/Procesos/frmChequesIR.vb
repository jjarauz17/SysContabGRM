...
Namespace DataGridTextBoxCombo
    Public Class frmChequesIR
        Inherits DevExpress.XtraEditors.XtraForm

        Private Shared ChildInstance As frmChequesIR = Nothing

        Public Shared Function Instance() As frmChequesIR
            If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
                ChildInstance = New frmChequesIR()
            End If
...
#Region " Código generado por el Diseñador de Windows Forms "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.GroupBox1.Size = New System.Drawing.Size(1000, 157)
            ...
            Me.etRuc.Location = New System.Drawing.Point(294, 38)
            Me.etRuc.Name = "etRuc"
            ...
            Me.txtRuc.Location = New System.Drawing.Point(392, 44)
            ...
            Me.Label9.Location = New System.Drawing.Point(704, 95)
            ...
            Me.etMontoLetras.Location = New System.Drawing.Point(152, 67)
            ...
            Me.etInicio.Location = New System.Drawing.Point(840, 78)
            ...
            Me.txtNombre.Location = New System.Drawing.Point(152, 17)
            ...
            Me.txtMonto.Location = New System.Drawing.Point(152, 44)
            ...
            Me.Label2.Location = New System.Drawing.Point(728, 47)
            ...
            Me.dtpFecha.Location = New System.Drawing.Point(840, 44)
            ...
            Me.txtConcepto.Location = New System.Drawing.Point(152, 106)
            ...
            Me.cbTipoComp.Location = New System.Drawing.Point(752, 95)
            ...
            Me.cbPagar2.Location = New System.Drawing.Point(640, 43)
            ...
            Me.Label7.Location = New System.Drawing.Point(360, 507)
            ...
            Me.txtDocumento.Location = New System.Drawing.Point(496, 507)
            ...
            Me.cmdAceptar.Location = New System.Drawing.Point(8, 507)
            ...
            Me.cmdSalir.Location = New System.Drawing.Point(272, 507)
            ...
            Me.dgCatalogo.Location = New System.Drawing.Point(8, 197)
            ...
            Me.dgCatalogo.Size = New System.Drawing.Size(1000, 293)
            ...
            Me.cmdRecalcular.Location = New System.Drawing.Point(184, 507)
            ...
            Me.cmdImprimir.Location = New System.Drawing.Point(96, 507)
            ...
            Me.AutoScroll = True
            Me.ClientSize = New System.Drawing.Size(1016, 540)
...
#End Region
        ...
        Private Sub frmChequesIR_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Private Function Guardar() As Boolean
            ...
            Try
                ...
                dsIR = VB.SysContab.PeriodoNominaDB.IRXMes(Me.Mes)

                For i = 0 To dsIR.Tables("Tabla").Rows.Count - 1
                    Comprobantes.PagosFactura(dsIR.Tables("Tabla").Rows(i).Item("Comp_No"), dsIR.Tables("Tabla").Rows(i).Item("Per_ID"), dsIR.Tables("Tabla").Rows(i).Item("Comp_Fecha"), dsIR.Tables("Tabla").Rows(i).Item("Monto"), NoComprob, VB.SysContab.PeriodosDB.Activo(Me.dtpFecha.Value), dtpFecha.Value, 0, 0, "022")
                Next
        ...
        Private Sub cmdImprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdImprimir.Click
            ...
            rFactura.Load(Application.StartupPath & "\Reportes\rptComprobanteCheque.rpt", CrystalDecisions.Shared.OpenReportMethod.OpenReportByDefault)
        ...
        Private Sub frmChequesIR_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
            Dim f As frmIRPagar = f.Instance
            f.dgPlanillas.DataSource = VB.SysContab.PeriodoNominaDB.IRPagar().Tables(0)
        End Sub
