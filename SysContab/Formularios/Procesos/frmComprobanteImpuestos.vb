...
Namespace DataGridTextBox
    Public Class frmComprobanteImpuestos
        Inherits DevExpress.XtraEditors.XtraForm

        Private Shared ChildInstance As frmComprobanteImpuestos = Nothing

        Public Shared Function Instance() As frmComprobanteImpuestos
            If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
                ChildInstance = New frmComprobanteImpuestos()
            End If
...
#Region " Código generado por el Diseñador de Windows Forms "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.Label25.Location = New System.Drawing.Point(440, 8)
            ...
            Me.NoComprobante.Location = New System.Drawing.Point(280, 496)
            ...
            Me.Label7.Location = New System.Drawing.Point(176, 496)
            ...
            Me.txtChequeNombre.TabIndex = 1017
            ...
            Me.txtTipo.Location = New System.Drawing.Point(488, 8)
            Me.txtTipo.MaxLength = 50
            Me.txtTipo.Name = "txtTipo"
            Me.txtTipo.ReadOnly = True
            Me.txtTipo.Size = New System.Drawing.Size(424, 20)
            ...
            Me.Name = "frmComprobanteImpuestos"
...
#End Region
        ...
        Private Sub frmComprobanteImpuestos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Private Sub cmdAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAceptar.Click
            ...
            If Validar() = True Then
                Try
                    ...
                    'Comprobantes.FacturaComprasTransaccionesAdd(2, CompNo, PeriodosDB.Activo(), dtFecha.Value, Me.Mes, Me.Year)
