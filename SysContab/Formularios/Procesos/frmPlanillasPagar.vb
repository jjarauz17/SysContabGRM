Public Class frmPlanillasPagar
    Inherits DevExpress.XtraEditors.XtraForm

    Private Shared ChildInstance As frmPlanillasPagar = Nothing

    Public Shared Function Instance() As frmPlanillasPagar
        If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
            ChildInstance = New frmPlanillasPagar()
        End If
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "frmPlanillasPagar"
        Me.Text = "Listado de Planillas a Pagar"
...
#End Region
    ...
    Private Sub frmPlanillasPagar_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        VB.SysContab.Rutinas.CambiarEstilo(Me)
        Dim Ds As New DataSet()
        Ds = VB.SysContab.PeriodoNominaDB.PlanillasPagar()
    ...
    Private Sub cmdSeleccionar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPagar.Click
        If Me.dgPlanillas.CurrentRowIndex < 0 Then
            MsgBox("Seleccione la Planilla que desea Pagar", MsgBoxStyle.Information)
            Exit Sub
        End If

        Dim f As DataGridTextBoxCombo.frmChequesPlanilla = f.Instance
        f.MdiParent = Me.MdiParent
        f.txtNombre.Text = NombreEmpresaActual
        f.cbPagar.Enabled = False
        f.txtMonto.Text = CDbl(Me.dgPlanillas.Item(Me.dgPlanillas.CurrentRowIndex, 4)).ToString(Round)
        ...
        f.txtConcepto.Text = "Pago Planilla " & Me.dgPlanillas.Item(Me.dgPlanillas.CurrentRowIndex, 1)
        ...
        f.Comp = Me.dgPlanillas.Item(Me.dgPlanillas.CurrentRowIndex, 7)
        f.Per = Me.dgPlanillas.Item(Me.dgPlanillas.CurrentRowIndex, 8)
        f.Fecha = Me.dgPlanillas.Item(Me.dgPlanillas.CurrentRowIndex, 10)

        Dim newRow1 As DataRow
        newRow1 = f.tCust.NewRow
        newRow1("Codigo1") = Me.dgPlanillas.Item(Me.dgPlanillas.CurrentRowIndex, 5)

        f.tCust.Rows.Add(newRow1)
        f.tCust.Rows(0)("Codigo") = Me.dgPlanillas.Item(Me.dgPlanillas.CurrentRowIndex, 5) & " - " & Me.dgPlanillas.Item(Me.dgPlanillas.CurrentRowIndex, 6)
        f.tCust.Rows(0)("Descripcion") = Me.dgPlanillas.Item(Me.dgPlanillas.CurrentRowIndex, 6)
        f.tCust.Rows(0)("Monto") = CDbl(f.txtMonto.Text).ToString(Round)
        f.tCust.Rows(0)("Concepto") = "Pago de Planilla"
