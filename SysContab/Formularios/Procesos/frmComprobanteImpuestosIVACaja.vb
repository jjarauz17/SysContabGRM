...
Namespace DataGridTextBox
    Public Class frmComprobanteImpuestosIVACaja
        Inherits DevExpress.XtraEditors.XtraForm

        Private Shared ChildInstance As frmComprobanteImpuestosIVACaja = Nothing

        Public Shared Function Instance() As frmComprobanteImpuestosIVACaja
            If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
                ChildInstance = New frmComprobanteImpuestosIVACaja()
            End If
...
#End Region
        ...
        Private Sub frmComprobanteImpuestosIVACaja_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Private Sub cmdAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAceptar.Click
            ...
            '    Dim f1 As frmReporteIVA = f1.Instance
            '    f1.CalculaTotal()
