...
Namespace DataGridTextBox
    Public Class frmComprobanteAlcaldiaImpuestosCaja
        Inherits DevExpress.XtraEditors.XtraForm

        Private Shared ChildInstance As frmComprobanteAlcaldiaImpuestosCaja = Nothing

        Public Shared Function Instance() As frmComprobanteAlcaldiaImpuestosCaja
            If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
                ChildInstance = New frmComprobanteAlcaldiaImpuestosCaja()
            End If
...
#Region " Código generado por el Diseñador de Windows Forms "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.NoComprobante.Location = New System.Drawing.Point(256, 496)
            ...
            Me.Label7.Location = New System.Drawing.Point(152, 496)
            ...
            Me.txtCodigoProveedor.Location = New System.Drawing.Point(680, 40)
            ...
            Me.txtBanco.Location = New System.Drawing.Point(128, 40)
            ...
            Me.lblBanco.Location = New System.Drawing.Point(16, 40)
            ...
            Me.dgFacturacionCliente.Location = New System.Drawing.Point(12, 64)
            ...
            Me.dgFacturacionCliente.Size = New System.Drawing.Size(884, 240)
            ...
            Me.txtCheque.Location = New System.Drawing.Point(480, 40)
            ...
            Me.lblCheque.Location = New System.Drawing.Point(368, 40)
            ...
            Me.txtMoneda.Location = New System.Drawing.Point(312, 8)
            ...
            '
            'frmComprobanteImpuestosIVACaja
            '
            ...
            Me.Name = "frmComprobanteImpuestosIVACaja"
...
#End Region
        ...
        Private Sub frmComprobanteAlcaldiaImpuestosCaja_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Private Sub MakeDataSet()
            ...
            '    tCust.Rows(j)("ProdServ") = ds.Tables("PlantillasDetalles").Rows(6).Item("Etiqueta")
            '    'tCust.Rows(j)("Descripcion") = ds.Tables("PlantillasDetalles").Rows(j).Item("Concepto")

            '    If CatalogoDB.GetDetails(ds.Tables("PlantillasDetalles").Rows(6).Item("Cuenta")).Tipo = "A" Then
            '        tCust.Rows(j)("Cuenta") = ds.Tables("PlantillasDetalles").Rows(6).Item("Cuenta")
            '        tCust.Rows(j)("Catalogo") = ds.Tables("PlantillasDetalles").Rows(6).Item("Catalogo")
            '    Else
            '        tCust.Rows(j)("Catalogo") = ""
            '    End If
            ...
            '    If ds.Tables("PlantillasDetalles").Rows(6).Item("Débito") = 1 Then
            '        tCust.Rows(j)("DC") = "Débito"
        ...
        Private Sub cmdAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAceptar.Click
            ...
            If Validar() = True Then
                Try
                    ...
                    Comprobantes.FacturaVentasTransaccionesAdd(3, CompNo, PeriodosDB.Activo(dtFecha.Value), dtFecha.Value, Me.Mes, Me.Year)
                ...
                Dim f1 As frmAlcaldia = f1.Instance
                f1.CalculaTotal()
                'f.Close()
