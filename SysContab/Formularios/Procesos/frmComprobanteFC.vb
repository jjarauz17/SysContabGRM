...
Namespace DataGridTextBox
    Public Class frmComprobanteFC
        Inherits DevExpress.XtraEditors.XtraForm

        Private Shared ChildInstance As frmComprobanteFC = Nothing

        Public Shared Function Instance() As frmComprobanteFC
            If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
                ChildInstance = New frmComprobanteFC()
            End If
...
#Region " Código generado por el Diseñador de Windows Forms "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.NoComprobante.Location = New System.Drawing.Point(328, 312)
            ...
            Me.Label7.Location = New System.Drawing.Point(224, 312)
            ...
            Me.txtNotaCredito.Location = New System.Drawing.Point(752, 80)
            ...
            Me.txtCheque.Location = New System.Drawing.Point(480, 80)
            ...
            Me.lblCheque.Location = New System.Drawing.Point(368, 80)
            ...
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.GroupBox2, Me.txtMoneda, Me.txtTasaCambio, Me.GroupBox1, Me.Label3, Me.Label2, Me.txtTipo, Me.Label25})
            Me.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.0!)
            Me.Name = "frmComprobanteFC"
...
#End Region
        ...
        Private Sub frmComprobanteFC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            tCust.Rows(0)("Monto") = CDbl(Me.etIva.Text).ToString(Round)
            ...
            tCust.Rows(1)("Monto") = CDbl(CDbl(Me.txtValor.Text)).ToString(Round)
            'tCust.Rows(0).Delete()
        ...
        Private Sub MakeDataSet()
            ...
            newRow1 = tCust.NewRow
            tCust.Rows.Add(newRow1)
            tCust.Rows(j)("ProdServ") = "Proveedor"
            ...
            CatalogoDetalle = CatalogoDB.GetDetails(Me.txtProvID.Text)
            tCust.Rows(j)("Cuenta") = CatalogoDetalle.Cuenta
            tCust.Rows(j)("Catalogo") = CatalogoDetalle.Nombre
            ...
            dsDetalleArticulo = VB.SysContab.ArticulosDB.GetDetails(dsDetalle.Tables("Facturas_Compras").Rows(0).Item("Item_ID"), "P")
            ...
            For i = 1 To dsDetalle.Tables("Facturas_Compras").Rows.Count - 1
                dsDetalleArticulo = VB.SysContab.ArticulosDB.GetDetails(dsDetalle.Tables("Facturas_Compras").Rows(i).Item("Item_ID"), "P")
        ...
        Private Sub cmdAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAceptar.Click
            ...
            If Validar() = True Then
                Try
                    ...
                    CompNo = Comprobantes.AddComprobante(TipoCompr, txtTasaCambio.Text, txtConcepto.Text, EmpresasDB.GetDetails(EmpresaActual).MonedaBase, PeriodosDB.Activo(dtFecha.Value), dtFecha.Value, 0, "", False, Me.txtProvID.Text, "", 0, Me.txtFact.Text, VB.SysContab.Rutinas.Fecha, 0, OrigenComprobantes.CHEQUE)
                    'Comprobantes.ActualizarCheque(Me.Banco)
                    Comprobantes.CancelarFactura(Me.txtFact.Text, Me.txtCodigoProveedor.Text, 1)
                    Dim Tipo As String
                    For filas = 0 To tCust.Rows.Count - 1
                        If tCust.Rows(filas)("DC") = "Débito" Then
                            'Debito = Debito + tCust.Rows(filas)("Monto")
        ...
        Private Sub frmComprobanteFC_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
            Dim f As frmFacturasComprasContabilizar = f.Instance
            Dim FacturasDB As New VB.SysContab.Facturas_ComprasDB()
            f.ds = FacturasDB.GetListxTipoProducto(0)
            f.dgProveedores.DataSource = f.ds.Tables("Tablas").DefaultView
        End Sub
