Public Class frmBancosAlcaldiaImpuestos
    Inherits DevExpress.XtraEditors.XtraForm

    Private Shared ChildInstance As frmBancosAlcaldiaImpuestos = Nothing
    ...
    Public Shared Function Instance() As frmBancosAlcaldiaImpuestos
        If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
            ChildInstance = New frmBancosAlcaldiaImpuestos()
        End If
...
#End Region
    ...
    Private Sub frmBancosAlcaldiaImpuestos_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cmdModificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdModificar.Click
        ...
        Dim f As DataGridTextBox.frmComprobanteAlcaldiaImpuestos = f.Instance
