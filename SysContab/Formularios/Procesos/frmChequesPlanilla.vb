...
Namespace DataGridTextBoxCombo
    Public Class frmChequesPlanilla
        Inherits DevExpress.XtraEditors.XtraForm

        Private Shared ChildInstance As frmChequesPlanilla = Nothing

        Public Shared Function Instance() As frmChequesPlanilla
            If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
                ChildInstance = New frmChequesPlanilla()
            End If
...
#Region " Código generado por el Diseñador de Windows Forms "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.GroupBox1.Size = New System.Drawing.Size(1000, 149)
            ...
            Me.etRuc.Location = New System.Drawing.Point(294, 34)
            Me.etRuc.Name = "etRuc"
            ...
            Me.txtRuc.Location = New System.Drawing.Point(392, 40)
            ...
            Me.Label9.Location = New System.Drawing.Point(712, 122)
            ...
            Me.etMontoLetras.Location = New System.Drawing.Point(294, 62)
            Me.etMontoLetras.Name = "etMontoLetras"
            Me.etMontoLetras.Size = New System.Drawing.Size(642, 23)
            ...
            Me.etInicio.Location = New System.Drawing.Point(876, 60)
            ...
            Me.txtMonto.Location = New System.Drawing.Point(152, 65)
            ...
            Me.cbPagar.Location = New System.Drawing.Point(152, 140)
            ...
            Me.txtConcepto.Location = New System.Drawing.Point(152, 91)
            ...
            Me.cbTipoComp.Location = New System.Drawing.Point(760, 122)
            ...
            Me.cbPagar2.Location = New System.Drawing.Point(640, 39)
            ...
            Me.txtDocumento.Location = New System.Drawing.Point(497, 485)
            ...
            Me.cmdAceptar.Location = New System.Drawing.Point(9, 485)
            ...
            Me.cmdSalir.Location = New System.Drawing.Point(273, 485)
            ...
            Me.dgCatalogo.Size = New System.Drawing.Size(1000, 290)
            ...
            Me.cmdRecalcular.Location = New System.Drawing.Point(185, 485)
            ...
            Me.cmdImprimir.Location = New System.Drawing.Point(97, 485)
...
#End Region
        ...
        Public Comp, Per, Fecha As String
        Dim Fechas As New VB.SysContab.FechasdeTrabajo

        Private Sub frmChequesPlanilla_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Private Function Guardar() As Boolean
            ...
            Try
                ...
                Comprobantes.PagosFactura(Me.Comp, Me.Per, Me.Fecha, Me.txtMonto.Text, NoComprob, VB.SysContab.PeriodosDB.Activo(Me.dtpFecha.Value), dtpFecha.Value, 0, 0, "008")
        ...
        Private Sub frmChequesPlanilla_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
            Dim f As frmPlanillasPagar = f.Instance
            f.dgPlanillas.DataSource = VB.SysContab.PeriodoNominaDB.PlanillasPagar().Tables(0)
        End Sub
