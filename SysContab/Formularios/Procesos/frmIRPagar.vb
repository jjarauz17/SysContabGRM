Public Class frmIRPagar
    Inherits DevExpress.XtraEditors.XtraForm

    Private Shared ChildInstance As frmIRPagar = Nothing

    Public Shared Function Instance() As frmIRPagar
        If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
            ChildInstance = New frmIRPagar()
        End If
...
#End Region
    ...
    Private Sub frmIRPagar_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        VB.SysContab.Rutinas.CambiarEstilo(Me)
        Dim Ds As New DataSet()
        Ds = VB.SysContab.PeriodoNominaDB.IRPagar()
    ...
    Private Sub cmdSeleccionar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPagar.Click
        ...
        Dim f As DataGridTextBoxCombo.frmChequesIR = f.Instance
        f.MdiParent = Me.MdiParent
        f.txtNombre.Text = "DGI" 'NombreEmpresaActual
        ...
        f.txtConcepto.Text = "Pago IR Mes " & Me.dgPlanillas.Item(Me.dgPlanillas.CurrentRowIndex, 0)
        ...
        f.tCust.Rows(0)("Concepto") = "Pago IR"
