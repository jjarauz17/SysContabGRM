Public Class frmKardexProducto
    ...
    Sub Cargar()
        iGrid.DataSource = ObtieneDatos("JAR_KardexInventarioxProducto",
                                        Producto,
                                        "P",
                                        Bodega,
                                        EmpresaActual)
    ...
    Private Sub frmKardexProducto_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
