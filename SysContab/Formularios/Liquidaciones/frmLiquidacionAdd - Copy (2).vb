...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Articulo As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents Cantidad As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents TotalFOB1 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents TotalFOB2 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents TotalFlete As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents TotalCIF As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents PagoMifin As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents PagoDAI As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents TotalGastos As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents CostoBodega As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents Costo1 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents Costo2 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents Margen As DevExpress.XtraGrid.Columns.GridColumn
    ...
    Friend WithEvents PagoISC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents PagoIVA As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents CantidadCaja As DevExpress.XtraGrid.Columns.GridColumn
    ...
    Friend WithEvents LiqID1 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents LiqDetGastoID As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents LiqDetalleID As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents cmdPrint As DevExpress.XtraEditors.SimpleButton
    Friend WithEvents cmdImportar As DevExpress.XtraEditors.SimpleButton
    Friend WithEvents Modified As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents ValorFob As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents Bonificados As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents Exento As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents Moneda As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents Costo3 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents ALiquidar As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents IDFactura As DevExpress.XtraGrid.Columns.GridColumn
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.LiqDetalleID = New DevExpress.XtraGrid.Columns.GridColumn
        Me.LiqID1 = New DevExpress.XtraGrid.Columns.GridColumn
        Me.Articulo = New DevExpress.XtraGrid.Columns.GridColumn
        ...
        Me.CantidadCaja = New DevExpress.XtraGrid.Columns.GridColumn
        Me.Bonificados = New DevExpress.XtraGrid.Columns.GridColumn
        Me.Cantidad = New DevExpress.XtraGrid.Columns.GridColumn
        Me.Saldo = New DevExpress.XtraGrid.Columns.GridColumn
        Me.ValorFob = New DevExpress.XtraGrid.Columns.GridColumn
        Me.TotalFOB1 = New DevExpress.XtraGrid.Columns.GridColumn
        Me.TotalFOB2 = New DevExpress.XtraGrid.Columns.GridColumn
        Me.TotalFlete = New DevExpress.XtraGrid.Columns.GridColumn
        Me.TotalCIF = New DevExpress.XtraGrid.Columns.GridColumn
        Me.PagoMifin = New DevExpress.XtraGrid.Columns.GridColumn
        Me.PagoDAI = New DevExpress.XtraGrid.Columns.GridColumn
        Me.PagoISC = New DevExpress.XtraGrid.Columns.GridColumn
        Me.PagoIVA = New DevExpress.XtraGrid.Columns.GridColumn
        Me.TotalGastos = New DevExpress.XtraGrid.Columns.GridColumn
        Me.CostoBodega = New DevExpress.XtraGrid.Columns.GridColumn
        Me.Costo1 = New DevExpress.XtraGrid.Columns.GridColumn
        Me.Costo2 = New DevExpress.XtraGrid.Columns.GridColumn
        Me.PrecioVenta = New DevExpress.XtraGrid.Columns.GridColumn
        Me.Margen = New DevExpress.XtraGrid.Columns.GridColumn
        Me.Costo3 = New DevExpress.XtraGrid.Columns.GridColumn
        Me.Exento = New DevExpress.XtraGrid.Columns.GridColumn
        Me.Moneda = New DevExpress.XtraGrid.Columns.GridColumn
        Me.Modified = New DevExpress.XtraGrid.Columns.GridColumn
        Me.ALiquidar = New DevExpress.XtraGrid.Columns.GridColumn
        Me.IDFactura = New DevExpress.XtraGrid.Columns.GridColumn
        ...
        Me.GridControl1.Location = New System.Drawing.Point(7, 0)
        ...
        Me.Articulo.OptionsColumn.AllowSize = False
        Me.Articulo.SummaryItem.DisplayFormat = "{0:n2}"
        Me.Articulo.SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Count
        Me.Articulo.Tag = ""
        Me.Articulo.Visible = True
        Me.Articulo.VisibleIndex = 0
        ...
        Me.ValorFob.Caption = "Precio Unitario FOB US$"
        Me.ValorFob.DisplayFormat.FormatString = "n4"
        ...
        Me.ValorFob.VisibleIndex = 1
        Me.ValorFob.Width = 90
        '
        'TotalFOB1
        '
        ...
        Me.TotalFOB1.Caption = "Total FOB $"
        Me.TotalFOB1.DisplayFormat.FormatString = "n2"
        ...
        Me.TotalFOB1.VisibleIndex = 3
        Me.TotalFOB1.Width = 50
        '
        'TotalFOB2
        '
        ...
        Me.TotalFOB2.Caption = "Total FOB C$"
        Me.TotalFOB2.DisplayFormat.FormatString = "n2"
        ...
        Me.TotalFOB2.VisibleIndex = 4
        Me.TotalFOB2.Width = 56
        '
        'TotalFlete
        '
        ...
        Me.TotalFlete.Visible = True
        Me.TotalFlete.VisibleIndex = 5
        Me.TotalFlete.Width = 46
        '
        'TotalCIF
        '
        ...
        Me.TotalCIF.Caption = "Total CIF C$"
        Me.TotalCIF.DisplayFormat.FormatString = "n2"
        ...
        Me.TotalCIF.VisibleIndex = 6
        Me.TotalCIF.Width = 50
        '
        'PagoMifin
        '
        ...
        Me.TotalGastos.DisplayFormat.FormatString = "n2"
        ...
        Me.TotalGastos.VisibleIndex = 11
        Me.TotalGastos.Width = 58
        '
        'CostoBodega
        '
        ...
        Me.CostoBodega.Caption = "Costo Bodega"
        Me.CostoBodega.DisplayFormat.FormatString = "n2"
        ...
        Me.CostoBodega.VisibleIndex = 12
        Me.CostoBodega.Width = 58
        '
        'Costo1
        '
        ...
        Me.Costo1.Caption = "Costo Unit. Bodega C$"
        Me.Costo1.DisplayFormat.FormatString = "n2"
        ...
        Me.Costo2.Caption = "Costo Unit. Bodega US$"
        Me.Costo2.DisplayFormat.FormatString = "n2"
        ...
        Me.tbRecibo.Location = New System.Drawing.Point(688, 122)
        ...
        Me.tbRecibo.Size = New System.Drawing.Size(136, 20)
        ...
        Me.Label16.Location = New System.Drawing.Point(624, 126)
        Me.Label16.Name = "Label16"
        Me.Label16.Size = New System.Drawing.Size(60, 16)
        Me.Label16.TabIndex = 14
        Me.Label16.Text = "Recibo No."
        '
        'tbPoliza
        '
        Me.tbPoliza.EnterMoveNextControl = True
        Me.tbPoliza.Location = New System.Drawing.Point(464, 122)
        ...
        Me.Label15.Location = New System.Drawing.Point(408, 126)
        ...
        Me.cmdSave.Location = New System.Drawing.Point(678, 12)
        ...
        Me.tbGranTotal.Location = New System.Drawing.Point(92, 94)
        ...
        Me.tbAnifoda.Location = New System.Drawing.Point(465, 5)
        ...
        Me.tbAnifoda.Size = New System.Drawing.Size(75, 20)
        ...
        Me.dtFechaLiq.Properties.EditFormat.FormatString = "dd-MMM-yy"
        Me.dtFechaLiq.Properties.EditFormat.FormatType = DevExpress.Utils.FormatType.DateTime
        Me.dtFechaLiq.Properties.LookAndFeel.UseDefaultLookAndFeel = False
        Me.dtFechaLiq.Properties.LookAndFeel.UseWindowsXPTheme = True
        Me.dtFechaLiq.Properties.Mask.EditMask = "dd-MMM-yy"
        Me.dtFechaLiq.Properties.Mask.UseMaskAsDisplayFormat = True
        ...
        Me.dtFechaLiq.Size = New System.Drawing.Size(136, 20)
        ...
        Me.GridControl2.Location = New System.Drawing.Point(425, 168)
        ...
        Me.GridControl2.Size = New System.Drawing.Size(400, 178)
        ...
        Me.GridControl3.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Bottom) _
                    Or System.Windows.Forms.AnchorStyles.Left), System.Windows.Forms.AnchorStyles)
        Me.GridControl3.Location = New System.Drawing.Point(8, 168)
        ...
        Me.GridControl3.Size = New System.Drawing.Size(400, 178)
        ...
        Me.Label11.Location = New System.Drawing.Point(424, 152)
        ...
        Me.ckSelectData.Location = New System.Drawing.Point(566, 15)
        ...
        Me.cmdPrint.Location = New System.Drawing.Point(839, 12)
        ...
        Me.cmdImportar.Location = New System.Drawing.Point(758, 12)
        Me.cmdImportar.LookAndFeel.UseDefaultLookAndFeel = False
...
#End Region
    ...
    Private Sub frmLiquidacionAdd_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cbProveedor.Properties.DataSource = ObtieneDatos("SELECT CODIGO,NOMBRE,ISNULL(Cuenta,'')AS Cuenta FROM Proveedores WHERE Empresa=" & EmpresaActual) 'p.ProveedoresListCombo().Tables("Proveedores")
        ...
        GridView1.Columns("PagoDAI").Visible = False
        dtFechaLiq.DateTime = Today
        ...
        If NewLiq = False Then
            ...
            If DTS.Rows.Count > 0 Then
                With DTS
                    Me.dtFechaLiq.DateTime = .Rows(0).Item(2)
                    ckTax.Checked = .Rows(0).Item(3)
                    tbTC.Text = .Rows(0).Item(5)
                    tbFactura.Text = .Rows(0).Item(6).Trim
                    tbValorFob.EditValue = .Rows(0).Item(7)
                    tbFlete1.EditValue = .Rows(0).Item(8)
                    tbBultos.EditValue = .Rows(0).Item(9)
                    tbBultosLiq.EditValue = .Rows(0).Item(10)
                    tbCuenta.Text = .Rows(0).Item(11).Trim
                    tbPoliza.Text = .Rows(0).Item(12).Trim
                    tbRecibo.Text = .Rows(0).Item(13).Trim
        ...
        ElseIf NewLiq And (Origen = 1 Or Origen = 3) Then
            ...
            DT1 = ObtieneDatos("SPJLiquidarGetFacturasDetalle " & "'" & FacSelec & "'," & "'" & ProvSelec & "'" & "," & Origen & "," & CInt(EmpresaActual))
        ...
        If ALiquidar1 = True Then
            GridView1.Columns("ALiquidar").Visible = True : GridView1.Columns("ALiquidar").VisibleIndex = 0
            GridView1.Columns("Saldo").Visible = True : GridView1.Columns("Saldo").VisibleIndex = 6
        ...
        If Directa Then
            ...
            For i As Integer = 0 To DT1.Rows.Count - 1
                GridView1.SetRowCellValue(i, "Saldo", DT1.Rows(i).Item("Cantidad"))
            Next
            tbBultosLiq.Text = GridView1.Columns("Cantidad").SummaryItem.SummaryValue
            Me.Origen = 2
        ...
        For k As Integer = 0 To GridView1.Columns.Count - 1
            If GridView1.Columns(k).Visible Then GridView1.Columns(k).BestFit()
        Next
    ...
    Private Function ReloadGrid(ByVal Var As String)
        If Origen <> 1 Then 'Para las tablas Liquidaciones y LiquidacionesDetalle
            ...
            ",0.00 AS PagoIVA,0.00 AS TotalGastos,0.00 AS CostoBodega,0.00 AS Costo1,0.00 AS Costo2,0.00 AS PrecioVenta,0.00 AS Margen,0 AS Modified,Exento,articulos.Moneda,0.00 AS Costo3,IDFactura, Unidad as UM FROM " & _
        ...
        Else 'Para las Tablas LiquidacionesIB y LiquidacionesIBDetalles -- INBOND
            ...
            ",0.00 AS TotalGastos,0.00 AS CostoBodega,0.00 AS Costo1,0.00 AS Costo2,0.00 AS PrecioVenta,0.00 AS Margen,0 AS Modified,Articulos.Exento,articulos.Moneda,0.00 AS Costo3,ld.IDFactura, Unidad as UM, p.NOMBRE AS ProvNombre" & _
    ...
    Private Sub GridView1_CellValueChanged(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles GridView1.CellValueChanged
        ...
        If e.Column.FieldName = "ArticuloID" Or e.Column.FieldName = "Cantidad" Then 'Or e.Column.FieldName = "ValorFob" Then
            If NewLiq Then
                DR = lArticulo.GetDataSourceRowByKeyValue(GridView1.GetRowCellValue(e.RowHandle, "ArticuloID"))
            Else
                DRT = ObtieneDatos("SELECT Codigo_Articulo AS Codigo,Nombre,Precio_Venta_Cordobas AS Precio,Exento,1 as Unidad,Moneda,Exento,Unidad as UM FROM Articulos WHERE Codigo_Articulo='" & GridView1.GetRowCellValue(e.RowHandle, "ArticuloID") & "'").Rows(0)
            End If
            ...
            With GridView1
                ...
                Else
                    ...
                    End If
                    .SetRowCellValue(e.RowHandle, "TotalCIF", IsNull(.GetRowCellValue(e.RowHandle, "TotalFOB2"), 0) + IsNull(.GetRowCellValue(e.RowHandle, "TotalFlete"), 0) + Math.Round(IVAProd, 2))
                End If
    ...
    Private Sub tbFlete1_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tbFlete1.EditValueChanged, tbBultos.EditValueChanged, tbBultosLiq.EditValueChanged, tbTC.EditValueChanged, tbValorFob.EditValueChanged
                    ...
                    For i As Integer = 0 To .DataRowCount
                        ...
                        Else
                            ...
                            If DR.Item("Exento") = 0 Then
                                ...
                                ArtImpCif += IsNull(.GetRowCellValue(i, "TotalFOB2"), 0) + IsNull(.GetRowCellValue(i, "TotalFlete"), 0) + Math.Round(IVAProd, 2)
                            End If
    ...
    Private Sub Calc2()
        ...
        If GridView1.Columns("TotalCIF").SummaryItem.SummaryValue <> 0 Then
            With GridView3
                For i As Integer = 0 To .DataRowCount - 1
                    If IsNull(.GetRowCellValue(i, "LiqGastoID"), 0) <> 0 And IsNull(.GetRowCellValue(i, "GastoMonto"), 0) <> 0 Then
                        .SetRowCellValue(i, "Porcentaje", Math.Round(.GetRowCellValue(i, "GastoMonto") / GridView1.Columns("TotalCIF").SummaryItem.SummaryValue, 9))
                    End If
                Next i
            End With
            With GridView2
                For j As Integer = 0 To .DataRowCount
                    .SetRowCellValue(j, "Porcentaje", Math.Round(.GetRowCellValue(j, "ImpMonto") / GridView1.Columns("TotalCIF").SummaryItem.SummaryValue, 9))
                Next j
            End With
        End If
        If NewLiq Then
            If GridView2.GetRowCellValue(0, "Monto") <> 0 Then GridView1.Columns("PagoIVA").Visible = True
            If GridView2.GetRowCellValue(2, "Monto") <> 0 Then GridView1.Columns("PagoDAI").Visible = True
        End If
        ...
        With GridView1
            For k As Integer = 0 To .DataRowCount
                ...
                Else
                    If GridView1.Columns("PagoDAI").Visible = True And GridView1.GetRowCellValue(k, "Exento") = 0 Then .SetRowCellValue(k, "PagoDAI", Math.Round(.GetRowCellValue(k, "TotalCIF") * GridView2.GetRowCellValue(0, "Porcentaje"), 9))
                    If GridView1.Columns("PagoIVA").Visible = True And GridView1.GetRowCellValue(k, "Exento") = 0 Then .SetRowCellValue(k, "PagoIVA", Math.Round(.GetRowCellValue(k, "TotalCIF") * GridView2.GetRowCellValue(0, "Porcentaje"), 9))
                ...
                .SetRowCellValue(k, "TotalGastos", Math.Round((.GetRowCellValue(k, "TotalCIF") * GastoSimple) + IIf(.GetRowCellValue(k, "UM") = "LTS", .GetRowCellValue(k, "TotalCIF") * tbAnifoda.EditValue / 100, 0), 9)) 'GridView3.Columns("Porcentaje").SummaryItem.SummaryValue, 2))
    ...
    Private Sub ckTax_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ckTax.CheckedChanged
        If ckTax.Checked Then
            GridView1.Columns("PagoDAI").Visible = True
            GridView1.Columns("PagoISC").Visible = True
            GridView1.Columns("PagoIVA").Visible = True
            GridView1.Columns("PagoMifin").Caption = "Imp. Globales"
            GridView1.Columns("Margen").OptionsColumn.ReadOnly = False
            tbBultos.Visible = True : tbBultosLiq.Visible = True
            Label8.Visible = True : Label9.Visible = True
        Else
            GridView1.Columns("PagoDAI").Visible = False
            GridView1.Columns("PagoISC").Visible = False
            GridView1.Columns("PagoIVA").Visible = False
            GridView1.Columns("PagoMifin").Caption = "Pago MIFIN"
            GridView1.Columns("Margen").OptionsColumn.ReadOnly = False
    ...
    Private Sub GridView3_RowUpdated(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.RowObjectEventArgs) Handles GridView3.RowUpdated, GridView2.RowUpdated
        ...
        If GridView1.DataRowCount <> 0 Then Calc2()
    End Sub
    ...
    Private Sub Gridview1_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles GridView1.MouseDown
        If e.Button = Windows.Forms.MouseButtons.Right And Origen <> 1 Then
    ...
    Private Sub ckSelectData_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ckSelectData.CheckedChanged
        If ckSelectData.Checked Then GridView1.ColumnsCustomization() : GridView1.CustomizationForm.Height = 300 Else GridView1.DestroyCustomization()
    End Sub
        ...
        With DT4
            If Grid <> 1 Then
                If Grid = 3 Then
                    ...
                    Conn.AddParameter("Monto", SqlDbType.Int, 5, ParameterDirection.Input, .Rows(i).Item("GastoMonto", DataRowVersion.Current))
                ...
                ElseIf Grid = 2 Then
                    If .Rows(i).Item("ImpMonto") <> 0 Then
                        ...
                        Conn.AddParameter("Monto", SqlDbType.Int, 5, ParameterDirection.Input, .Rows(i).Item("ImpMonto", DataRowVersion.Current))
                ...
                Conn.AddParameter("FacturaNo", SqlDbType.NVarChar, 20, ParameterDirection.Input, .Rows(i).Item("Orgien"))
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Try
            ...
            Conn.AddParameter("Factura", SqlDbType.NChar, 10, ParameterDirection.Input, FacSelec)
            ...
            Conn.AddParameter("BultosIn", SqlDbType.Decimal, 10, ParameterDirection.Input, IIf(ckTax.Checked, tbBultos.EditValue, GridView1.Columns("Cantidad").SummaryItem.SummaryValue))
            Conn.AddParameter("BultosLiq", SqlDbType.Decimal, 10, ParameterDirection.Input, IIf(ckTax.Checked, tbBultosLiq.EditValue, GridView1.Columns("Cantidad").SummaryItem.SummaryValue))
            ...
            '    GridView1_RowUpdated(Nothing, Nothing)
            'End If
            GridView1.Columns("ALiquidar").Visible = False : GridView1.Columns("Saldo").Visible = False
    ...
    Private Sub cmdImportar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdImportar.Click
        ...
        Dim Cuentas(GridView1.DataRowCount - 1) As String
        Dim Montos(GridView1.DataRowCount - 1) As Double
        ...
        LiqNo = ObtieneDatos("SELECT LiqNo FROM Liquidaciones WHERE LiqID=" & LiqID).Rows(0).Item(0)
        Try
            ...
            IRAlcaldiaPAgado = ObtieneDatos("SELECT ir_pagado_alcaldia FROM Facturas_Compras WHERE EmpresaID=" & EmpresaActual & " AND IDFactura=" & FacturaID).Rows(0).Item(0)

            For i As Int16 = 0 To GridView1.DataRowCount - 1
                DetallesProducto = VB.SysContab.ArticulosDB.GetDetails(GridView1.GetRowCellValue(i, "ArticuloID"), "P", EmpresaActual)
                If DetallesProducto.Cuenta = "" Or DetallesProducto.Cuenta = "0" Then
                    CuentaTemp = GridView1.GetRowCellDisplayText(i, "ArticuloID") + ","
                End If
            Next
            ...
            Else
                For i As Int16 = 0 To GridView1.RowCount - 1
                    ...
                    If j = -1 Then
                        ...
                        Montos(x) = GridView1.GetRowCellValue(i, "Costo3") 'tCust.Rows(i)("SubTotal")
                        x += 1
                    Else
                        Montos(j) = Montos(j) + GridView1.GetRowCellValue(i, "Costo3")
                    End If
                Next
            End If
            ...
            '''Dim DTContab As DataTable ': Dim IRAlcaldiaPAgado As Boolean
            '''Dim Cuentas(GridView1.RowCount) As String
            '''Dim Montos(GridView1.RowCount) As Double
            '''Dim x As Int16
            '''DTContab = ObtieneDatos("SELECT FC.Factura_ID,FC.IDFactura,ir_pagado_alcaldia FROM Facturas_Compras FC JOIN LiquidacionesDetalle ld ON FC.IDFactura = ld.IDFactura " & _
            '''"JOIN Liquidaciones l ON ld.LiqID = l.LiqID AND fc.Empresa_ID = l.EmpresaID WHERE ld.LiqID =" & Me.LiqID)
            ''''DTContab = ObtieneDatos("SELECT Factura_ID,IDFactura,ir_pagado_alcaldia FROM Facturas_Compras WHERE Factura_ID IN (" & FacSelec & ")")
            ...
            '''    If Contabilizar(Cuentas, Montos, DTContab.Rows(t).Item(2), DTContab.Rows(t).Item(0), DTContab.Rows(t).Item(1)) = False Then
    ...
    Private Function Contabilizar(ByVal Cuentas() As String, ByVal Montos() As Double, ByVal IRAlcaldiaPagado As Boolean, ByVal LaFactura As String, ByVal ElIDFactura As Int16) As Boolean
        ...
        IvaAsumido = ObtieneDatos("SELECT Iva_Asumido FROM Facturas_Compras WHERE IDFactura = " & ElIDFactura & " AND Proveedor_ID = " & cbProveedor.EditValue).Rows(0).Item(0)
        ...
        If (GridView1.Columns("Costo1").SummaryItem.SummaryValue - GridView1.Columns("PagoIVA").SummaryItem.SummaryValue) >= ConfigDetalles.MontoIR Then
            IRxPagar = CDbl((GridView1.Columns("Costo1").SummaryItem.SummaryValue - IIf(IvaAsumido, (SubTotalParaIVA * (ConfigDetalles.IVA / 100.0)).ToString(Round), GridView1.Columns("PagoIVA").SummaryItem.SummaryValue)) * Math.Round((IRPorcentaje / 100), 2))
        End If
        ...
        TipoFactura = ObtieneDatos("SELECT FormaPago_ID FROM Facturas_Compras WHERE IDFactura =" & ElIDFactura).Rows(0).Item(0)
        ...
        If IRAlcaldiaPagado = True Then
            ...
            If CDbl((GridView1.Columns("Costo1").SummaryItem.SummaryValue - IIf(IvaAsumido, (SubTotalParaIVA * (ConfigDetalles.IVA / 100.0)).ToString(Round), GridView1.Columns("PagoIVA").SummaryItem.SummaryValue))).ToString(Round) >= MunDet.Impuesto_SVenta_Min Then
                ValorIRAlcaldia = CDbl((GridView1.Columns("Costo1").SummaryItem.SummaryValue - IIf(IvaAsumido, (SubTotalParaIVA * (ConfigDetalles.IVA / 100.0)).ToString(Round), GridView1.Columns("PagoIVA").SummaryItem.SummaryValue))).ToString(Round) * (MunDet.Impuesto_SVenta / 100) 'CDbl(Me.etSubTotal.Text) * (MunDet.Impuesto_SVenta / 100)
            Else
                ValorIRAlcaldia = 0
            End If
        Else
        ...
        If FormaPago.FormaPagoDias(TipoFactura) = 0 Then  'Contado
            ...
            CompNo = Comprobantes.AddComprobante(TipoCompr, 1, _
                ...
                PeriodosDB.Activo(Today.Date), Today.Date, 0, "", False, Me.cbProveedor.EditValue, "", 1, LaFactura, VB.SysContab.Rutinas.Fecha, TipoFactura, OrigenComprobantes.ENTRADA_ALMACEN)
            ...
            If DetallesProveedor.Exento = False Then
                ...
                '(etTotal.Text - GridView1.Columns("IVA").SummaryItem.SummaryValue) >= ConfigDetalles.MontoIR Then
                If CDbl((GridView1.Columns("Costo1").SummaryItem.SummaryValue - IIf(IvaAsumido, (SubTotalParaIVA * (ConfigDetalles.IVA / 100.0)).ToString(Round), GridView1.Columns("PagoIVA").SummaryItem.SummaryValue))).ToString(Round) >= ConfigDetalles.MontoIR Then
                    'Agregar la linea del IR
            ...
            End If
            'End If
            If IIf(GridView1.Columns("PagoIVA").SummaryItem.SummaryValue = "", 0, CDbl(GridView1.Columns("PagoIVA").SummaryItem.SummaryValue)) <> 0 Then
                'Se agrega la cuenta del IVA
                Comprobantes.AddComprobanteDetalles(CompNo, ds.Tables("PlantillasDetalles").Rows(1).Item("Cuenta"), "", GridView1.Columns("PagoIVA").SummaryItem.SummaryValue, 0, TipoCompr, "D", LaFactura, 0, Today.Date, 1)
            End If
            'Se agrega la cuenta del banco
            Comprobantes.AddComprobanteDetalles(CompNo, ds.Tables("PlantillasDetalles").Rows(2).Item("Cuenta"), "Banco", GridView1.Columns("Costo1").SummaryItem.SummaryValue - IRxPagar - ValorIRAlcaldia, 0, TipoCompr, "C", LaFactura, 0, Today.Date, 1)
        ...
        Else
            ...
            ' en el campo Tipo, se enviaba '0' y segun la tabla de Comprobantes, ese campo debe tener 1 si es factura de proveedor
            CompNo = Comprobantes.AddComprobante(TipoCompr, 1, "Comprobante de Factura de Compra de Crédito a Proveedor #" & LaFactura, EmpresasDB.GetDetails(EmpresaActual).MonedaBase, PeriodosDB.Activo(Today.Date), Today.Date, 0, "", False, cbProveedor.EditValue, "", 1, LaFactura, VB.SysContab.Rutinas.Fecha, TipoFactura, OrigenComprobantes.ENTRADA_ALMACEN)
            ...
            '    End If
            If IIf(GridView1.Columns("PagoIVA").SummaryItem.SummaryValue = "", 0, CDbl(GridView1.Columns("PagoIVA").SummaryItem.SummaryValue)) <> 0 Then
                Comprobantes.AddComprobanteDetalles(CompNo, ds.Tables("PlantillasDetalles").Rows(0).Item("Cuenta"), "", GridView1.Columns("PagoIVA").SummaryItem.SummaryValue, 0, TipoCompr, "D", LaFactura, 0, Today.Date, 1)
            End If
            'Agregar las lineas de las cuentas de los productos
            'Antes era: Comprobantes.AddComprobanteDetalles(CompNo, DetallesProducto.Cuenta, "", GridView1.Columns("Costo1").SummaryItem.SummaryValue, 0, TipoCompr, "C", LaFactura, 0, Today.Date, 1)
            Dim x As Integer
            For x = 0 To Cuentas.GetUpperBound(0)
                If Cuentas(x) <> "" Then
                    Comprobantes.AddComprobanteDetalles(CompNo, Cuentas(x), "", Montos(x), 0, TipoCompr, "D", LaFactura, 0, Today.Date, 1)
            ...
            Comprobantes.AddComprobanteDetalles(CompNo, DetallesProveedor.Cuenta, "", GridView1.Columns("Costo1").SummaryItem.SummaryValue - IRxPagar - ValorIRAlcaldia, 0, TipoCompr, "C", LaFactura, 0, Today.Date, 0)

            'If Ir_Prod = True Or Ir_Serv = True Then
            If DetallesProveedor.Exento = False Then

                'If (etTotal.Text - GridView1.Columns("IVA").SummaryItem.SummaryValue) >= ConfigDetalles.MontoIR Then
                If CDbl((GridView1.Columns("Costo1").SummaryItem.SummaryValue - IIf(IvaAsumido, (SubTotalParaIVA * (ConfigDetalles.IVA / 100.0)).ToString(Round), GridView1.Columns("PagoIVA").SummaryItem.SummaryValue))).ToString(Round) >= ConfigDetalles.MontoIR Then
                    'Agregar la linea del IR
                    Comprobantes.AddComprobanteDetalles(CompNo, _
                    ds.Tables("PlantillasDetalles").Rows(1).Item("Cuenta"), "", _
                     IRxPagar, _
                    0, TipoCompr, "C", LaFactura, 0, Today.Date, 1)
                End If
            End If
            'End If
