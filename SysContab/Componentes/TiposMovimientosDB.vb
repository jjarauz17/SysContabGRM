...
Namespace VB.SysContab
    ...
    Public Class TipoMovimientoDB
        ...
        Public Function AddItem(ByVal Codigo As String, ByVal Descripcion As String, ByVal Unico As String)
        ...
        Public Function Update(ByVal Codigo As String, ByVal Descripcion As String, ByVal Unico As String)
