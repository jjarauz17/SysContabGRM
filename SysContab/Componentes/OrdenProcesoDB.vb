...
Namespace VB.SysContab
    ...
    Public Class OrdenProcesoDetails
    ...
    Public Class OrdenProcesoDB
        ...
        Public Function Numero() As Integer
            ...
            Dim cmd As SqlCommand = New SqlCommand("_OrdenesProcesoNumero", DBConn)
        ...
        Public Function OrdenProcesoDetalle(ByVal Factura As String) As DataSet
            Dim DBConn As SqlConnection
            ...
            DBCommand = New SqlDataAdapter("_OrdenesProcesoDetalle", DBConn)
            ...
            DBCommand.Fill(dsFicha, "Ordenes_Proceso")
        ...
        Public Function OrdenProcesoDelete(ByVal Factura As String)
            ...
            Dim cmd As SqlCommand = New SqlCommand("_OrdenesProcesoDelete", DBConn)
        ...
        Public Function AddLineas(ByVal Factura As String, ByVal Item As String, ByVal Cantidad As String, _
            ...
            Dim cmd As SqlCommand = New SqlCommand("_OrdenesProcesoAddLineas", DBConnFacturas)
        ...
        Public Function ListOrdenesProceso(ByVal Filtro As String, ByVal Estado As String) As DataSet
            Dim DBConn As SqlConnection
            Dim DBCommand As SqlDataAdapter
            Dim dsFicha As New DataSet()
            ...
            DBCommand = New SqlDataAdapter("_OrdenesProcesoList", DBConn)
        ...
        Public Function AddOrdenProceso(ByVal Factura As String, ByVal Fecha As String, ByVal Cliente As String, _
            ...
            Dim cmd As SqlCommand = New SqlCommand("_OrdenesProcesoAdd", DBConnFacturas)
        ...
        Public Function UpdateEstado(ByVal Factura As String)
            Dim cmd As SqlCommand = New SqlCommand("_OrdenesProcesoUpdateEstado", DBConnFacturas)
