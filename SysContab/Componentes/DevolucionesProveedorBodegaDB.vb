...
Namespace VB.SysContab
    ...
    Public Class DevolucionesProveedorBodegaDB
        ...
        Public Function Numero() As String
            ...
            Dim cmd As SqlCommand = New SqlCommand("_DevolucionProveedorBodegaNumero", DBConn)
        ...
        Public Sub AddItem(ByVal DevolucionBodega As String, ByVal Devolucion As String)
            Dim cmd As SqlCommand = New SqlCommand("_DevolucionProveedorBodegaAdd", DBConnFacturas)
        ...
        Public Sub AddItemDetalle(ByVal DevolucionBodega As String, ByVal Item As String, ByVal Cantidad As String)
            Dim cmd As SqlCommand = New SqlCommand("_DevolucionProveedorBodegaDetalleAdd", DBConnFacturas)
        ...
        Public Sub UpdateItem(ByVal Factura As String, ByVal Item As String, ByVal Tipo As String, ByVal Devuelto As String)
        ...
        Public Function GetList(ByVal Factura As String, ByVal Proveedor As String, ByVal Fecha1 As String, ByVal Fecha2 As String) As DataSet
            ...
            DBCommand.Fill(dsFicha, "DevolucionesProveedor")
        ...
        Public Function DevolucionDetalleNew(ByVal Devolucion As String, ByVal Factura As String, ByVal Proveedor As String) As DataSet
            Dim DBConn As SqlConnection
            Dim DBCommand As SqlDataAdapter
            Dim dsFicha As New DataSet()
            ...
            DBCommand = New SqlDataAdapter("_DevolucionProveedorBodegaDetalleNew", DBConn)
        ...
        Public Function DevolucionBodegaDetalle(ByVal Devolucion As String) As DataSet
            ...
            DBCommand = New SqlDataAdapter("_DevolucionProveedorBodegaDetalle", DBConn)
