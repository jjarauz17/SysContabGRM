...
Namespace VB.SysContab
    ...
    Public Class Grupos_DepreciacionDB
        ...
        Public Shared Sub AddItem(ByVal Codigo As String,
            ByVal Descripcion As String,
            ByVal Vida_Util As String,
            ByVal Porcentaje_Depreciacion As String,
            ByVal Periodo As String,
            ByVal Activo As String, ByVal Depreciacion As String,
        ...
        Public Shared Sub Update(ByVal Codigo As String, ByVal Descripcion As String,
                                ByVal Vida_Util As String, ByVal Porcentaje_Depreciacion As String,
                                ByVal Periodo As String,
                                ByVal Activo As String, ByVal Depreciacion As String,
                                ByVal Gastos As String)
