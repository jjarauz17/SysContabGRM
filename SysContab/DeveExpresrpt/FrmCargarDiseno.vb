...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    Friend WithEvents btnGuardar As DevExpress.XtraReports.UserDesigner.CommandBarItem
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btnGuardar = New DevExpress.XtraReports.UserDesigner.CommandBarItem
        ...
        Me.XrDesignDockManager2 = New DevExpress.XtraReports.UserDesigner.XRDesignDockManager
        ...
        Me.XrDesignPanel1.Location = New System.Drawing.Point(0, 53)
        Me.XrDesignPanel1.Name = "XrDesignPanel1"
        Me.XrDesignPanel1.Padding = New System.Windows.Forms.Padding(1)
        Me.XrDesignPanel1.Size = New System.Drawing.Size(600, 476)
        ...
        Me.DesignBar2.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.btnGuardar), New DevExpress.XtraBars.LinkPersistInfo(Me.CommandBarItem34, True), New DevExpress.XtraBars.LinkPersistInfo(Me.CommandBarItem35), New DevExpress.XtraBars.LinkPersistInfo(Me.CommandBarItem36)})
        Me.DesignBar2.Text = "Main Toolbar"
        '
        'btnGuardar
        '
        Me.btnGuardar.Caption = "&Save"
        Me.btnGuardar.Command = DevExpress.XtraReports.UserDesigner.ReportCommand.SaveFile
        Me.btnGuardar.Enabled = False
        Me.btnGuardar.Hint = "Save a report"
        Me.btnGuardar.Id = 36
        Me.btnGuardar.ImageIndex = 11
        ...
        Me.BarSubItem1.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.CommandBarItem39), New DevExpress.XtraBars.LinkPersistInfo(Me.btnGuardar, True), New DevExpress.XtraBars.LinkPersistInfo(Me.CommandBarItem40), New DevExpress.XtraBars.LinkPersistInfo(Me.CommandBarItem41, True)})
        ...
        Me.cmdoriginal.Appearance.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.cmdoriginal.Appearance.Options.UseFont = True
        Me.cmdoriginal.Appearance.Options.UseTextOptions = True
        Me.cmdoriginal.Appearance.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap
        'Me.cmdoriginal.Image = Global.Sts.SnackBarAdmin.My.Resources.Resources.RibbonPrintPreview_CustomizeLarge1
        Me.cmdoriginal.Location = New System.Drawing.Point(742, 16)
        Me.cmdoriginal.Name = "cmdoriginal"
        Me.cmdoriginal.Size = New System.Drawing.Size(96, 34)
        Me.cmdoriginal.TabIndex = 6
        Me.cmdoriginal.Text = "Diseño Original"
        '
        'XrDesignDockManager1
        '
        Me.XrDesignDockManager1.Form = Me
        Me.XrDesignDockManager1.HiddenPanels.AddRange(New DevExpress.XtraBars.Docking.DockPanel() {Me.DockPanel1})
        ...
        Me.DockPanel1.FloatLocation = New System.Drawing.Point(640, 227)
        ...
        Me.PropertyGridDockPanel1.Location = New System.Drawing.Point(600, 53)
        Me.PropertyGridDockPanel1.Name = "PropertyGridDockPanel1"
        Me.PropertyGridDockPanel1.ShowCategories = False
        Me.PropertyGridDockPanel1.Size = New System.Drawing.Size(250, 476)
        ...
        Me.PropertyGridDockPanel1_Container.Size = New System.Drawing.Size(244, 448)
...
#End Region
    ...
    Private Sub FrmConfiguraCheque_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim DT As DataTable = ObtieneDatos("SELECT * FROM Formatos Where Tipo = " & Tipo & " AND Empresa = " & EmpresaActual)
        ...
        Try
            Dim Data() As Byte
            Data = CType(ObtieneDatos("SELECT ChequeD FROM Formatos WHERE Tipo = " & Tipo & " AND Empresa = " & EmpresaActual).Rows(0).Item(0), Byte())
    ...
    Private Sub cmbboolean_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbboolean.SelectedIndexChanged
        'For Each i As Object In Me.XrDesignPanel1.GetSelectedComponents
        '    If TypeOf (i) Is DevExpress.XtraReports.UI.XRLabel Then
        '        CType(i, DevExpress.XtraReports.UI.XRLabel).Visible = IIf(cmbboolean.SelectedIndex = 0, True, False)
        '    End If
        'Next
    End Sub

    Private Sub XrDesignPanel1_SelectionChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles XrDesignPanel1.SelectionChanged
        'For Each i As Object In Me.XrDesignPanel1.GetSelectedComponents
        '    If TypeOf (i) Is DevExpress.XtraReports.UI.XRLabel Then
        '        cmbboolean.SelectedIndex = IIf(CType(i, DevExpress.XtraReports.UI.XRLabel).Visible = True, 0, 1)
        '        cmbbordes.SelectedIndex = IIf(CType(i, DevExpress.XtraReports.UI.XRLabel).Borders = DevExpress.XtraPrinting.BorderSide.All, 0, 1)
        '    End If
        '    If TypeOf (i) Is DevExpress.XtraReports.UI.XRTableCell Then
        '        cmbbordes.SelectedIndex = IIf(CType(i, DevExpress.XtraReports.UI.XRTableCell).Borders = DevExpress.XtraPrinting.BorderSide.All, 0, 1)
        '    End If
        'Next
    End Sub

    Private Sub cmbfecha_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbfecha.SelectedIndexChanged
        'For Each i As Object In Me.XrDesignPanel1.GetSelectedComponents
        '    If TypeOf (i) Is DevExpress.XtraReports.UI.XRLabel Then
        '        Select Case cmbfecha.SelectedIndex
        '            Case 0 : CType(i, DevExpress.XtraReports.UI.XRLabel).DataBindings.Item(0).FormatString = "{0:dd/MM/yyyy}"
        '            Case 1 : CType(i, DevExpress.XtraReports.UI.XRLabel).DataBindings.Item(0).FormatString = "{0:dddd, dd MMMM yyyy}"
        '            Case 2 : CType(i, DevExpress.XtraReports.UI.XRLabel).DataBindings.Item(0).FormatString = "{0:dd}"
        '            Case 3 : CType(i, DevExpress.XtraReports.UI.XRLabel).DataBindings.Item(0).FormatString = "{0:MM}"
        '            Case 4 : CType(i, DevExpress.XtraReports.UI.XRLabel).DataBindings.Item(0).FormatString = "{0:yyyy}"
        '            Case 5 : CType(i, DevExpress.XtraReports.UI.XRLabel).DataBindings.Item(0).FormatString = "{0:#,0.00}"
        '        End Select
    ...
    Private Sub cmbbordes_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbbordes.SelectedIndexChanged
        'For Each i As Object In Me.XrDesignPanel1.GetSelectedComponents
        '    If TypeOf (i) Is DevExpress.XtraReports.UI.XRLabel Then
        '        Select Case cmbbordes.SelectedIndex
        '            Case 0 : CType(i, DevExpress.XtraReports.UI.XRLabel).Borders = DevExpress.XtraPrinting.BorderSide.All
        '            Case 1 : CType(i, DevExpress.XtraReports.UI.XRLabel).Borders = DevExpress.XtraPrinting.BorderSide.None
        '            Case 2 : CType(i, DevExpress.XtraReports.UI.XRLabel).Borders = DevExpress.XtraPrinting.BorderSide.Top
        '            Case 3 : CType(i, DevExpress.XtraReports.UI.XRLabel).Borders = DevExpress.XtraPrinting.BorderSide.Bottom
        '            Case 4 : CType(i, DevExpress.XtraReports.UI.XRLabel).Borders = DevExpress.XtraPrinting.BorderSide.Right
        '            Case 5 : CType(i, DevExpress.XtraReports.UI.XRLabel).Borders = DevExpress.XtraPrinting.BorderSide.Left
        '        End Select
        '    End If
        '    If TypeOf (i) Is DevExpress.XtraReports.UI.XRTableCell Then
        '        Select Case cmbbordes.SelectedIndex
        '            Case 0 : CType(i, DevExpress.XtraReports.UI.XRTableCell).Borders = DevExpress.XtraPrinting.BorderSide.All
        '            Case 1 : CType(i, DevExpress.XtraReports.UI.XRTableCell).Borders = DevExpress.XtraPrinting.BorderSide.None
        '            Case 2 : CType(i, DevExpress.XtraReports.UI.XRTableCell).Borders = DevExpress.XtraPrinting.BorderSide.Top
        '            Case 3 : CType(i, DevExpress.XtraReports.UI.XRTableCell).Borders = DevExpress.XtraPrinting.BorderSide.Bottom
        '            Case 4 : CType(i, DevExpress.XtraReports.UI.XRTableCell).Borders = DevExpress.XtraPrinting.BorderSide.Right
        '            Case 5 : CType(i, DevExpress.XtraReports.UI.XRTableCell).Borders = DevExpress.XtraPrinting.BorderSide.Left
        '        End Select
        '    End If
        'Next
    End Sub

    Private Sub hideContainerRight_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
