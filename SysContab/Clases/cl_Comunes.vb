    ...
    Private Sub SendEmail(ByVal email As String, ByVal nombreclase As String, ByVal mensajeerror As String)
        ...
        Try
            ...
            Using mm As New MailMessage()
                ...
                Dim _DT As DataTable = ObtieneDatos("sp_myCredencialesWebMail", EmpresaActual)

                mm.From = New MailAddress(
                    _DT.Rows.Item(0)("Correo"),
                    "Informática, Dpto. Análisis y Desarrollo!",
                    System.Text.Encoding.UTF8)

                ' mm.ReplyTo = New MailAddress("jonnys.arauz@ramac.com.ni", "Ing. Jonnys Arauz", System.Text.Encoding.UTF8)

                mm.To.Add(email)
                mm.Bcc.Add(_DT.Rows.Item(0)("Copia"))
                ...
                smtp.Host = _DT.Rows.Item(0)("Host")
                smtp.EnableSsl = _DT.Rows.Item(0)("SSL")
                Dim NetworkCred As New NetworkCredential(
                    _DT.Rows.Item(0)("Correo").ToString(),
                    _DT.Rows.Item(0)("Clave").ToString())
                smtp.UseDefaultCredentials = True
                smtp.Credentials = NetworkCred
                smtp.Port = _DT.Rows.Item(0)("Puerto")
                smtp.Send(mm)
