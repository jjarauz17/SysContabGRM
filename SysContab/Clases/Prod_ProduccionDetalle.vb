...
Public Class Prod_ProduccionDetalle
    ...
    Dim vCantidadProduccion As Double

    Public Property CantidadProduccion() As Double
        Get
            Return vCantidadProduccion
        End Get
        Set(ByVal value As Double)
            vCantidadProduccion = value
        End Set
    End Property
    ...
    Dim vCOSTO_PROM As Double

    Public Property COSTO_PROM() As Double
        Get
            Return vCOSTO_PROM
        End Get
        Set(ByVal value As Double)
    ...
    Dim vCOSTO_ULTIMO As Double

    Public Property COSTO_ULTIMO() As Double
        Get
            Return vCOSTO_ULTIMO
        End Get
        Set(ByVal value As Double)
            vCOSTO_ULTIMO = value
        End Set
