...
namespace ZohoApi.OAuth.ClientApp
{
    public class ZohoOAuthFilePersistence : IZohoPersistenceHandler
    {
        ...
        public ZohoOAuthTokens GetOAuthTokens(string userMailId)
        {
            ...
            try
            {
                ...
                Dictionary<string, string> oauthTokens = 
                    ZohoOAuthUtil.GetFileAsDict(new FileStream(GetPersistenceHandlerFilePath(), FileMode.Open));
