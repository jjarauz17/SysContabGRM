...
namespace ZohoApi
{
    public class CommonUtil
    {
        ...
        public static void CheckIsPhotoSupported(string moduleAPIName)
        {
            ...
            {
                throw new Exception("Given module is not a photo supported module");
            }
        }
        ...
        public static void ValidateFile(string filePath)
        {
            ...
            {
                throw new Exception("File size is more than allowed size " + APIConstants.MAX_ALLOWED_FILE_SIZE_IN_MB + "MB.");
            }
        }
